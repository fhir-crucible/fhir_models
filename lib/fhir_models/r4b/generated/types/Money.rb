  ...
  module R4B
    class Money < FHIR::Model
      ...
      METADATA = {
        ...
        '_currency' => {'type'=>'Element', 'path'=>'Money._currency', 'min'=>0, 'max'=>1}
      }
      ...
      attr_accessor :_currency # 0-1 Element
    end
  end
end