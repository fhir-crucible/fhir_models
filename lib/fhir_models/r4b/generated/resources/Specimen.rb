  ...
  module R4B
    class Specimen < FHIR::Model
      ...
      METADATA = {
        ...
        '_id' => {'type'=>'Element', 'path'=>'Specimen._id', 'min'=>0, 'max'=>1},
        'meta' => {'type'=>'Meta', 'path'=>'Specimen.meta', 'min'=>0, 'max'=>1},
        'implicitRules' => {'type'=>'uri', 'path'=>'Specimen.implicitRules', 'min'=>0, 'max'=>1},
        '_implicitRules' => {'type'=>'Element', 'path'=>'Specimen._implicitRules', 'min'=>0, 'max'=>1},
        ...
        '_language' => {'type'=>'Element', 'path'=>'Specimen._language', 'min'=>0, 'max'=>1},
        ...
        '_status' => {'type'=>'Element', 'path'=>'Specimen._status', 'min'=>0, 'max'=>1},
        ...
        '_receivedTime' => {'type'=>'Element', 'path'=>'Specimen._receivedTime', 'min'=>0, 'max'=>1},
      ...
      class Processing < FHIR::Model
        ...
        METADATA = {
          ...
          'procedure' => {'valid_codes'=>{'http://terminology.hl7.org/CodeSystem/v2-0373'=>['LDLP', 'RECA', 'DEFB', 'ACID', 'NEUT', 'ALK', 'FILT', 'UFIL']}, 'type'=>'CodeableConcept', 'path'=>'Processing.procedure', 'min'=>0, 'max'=>1, 'binding'=>{'strength'=>'example', 'uri'=>'http://hl7.org/fhir/ValueSet/specimen-processing-procedure'}},
      ...
      attr_accessor :_receivedTime       # 0-1 Element
