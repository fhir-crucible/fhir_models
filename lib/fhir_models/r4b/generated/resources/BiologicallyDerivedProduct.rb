  ...
  module R4B
    class BiologicallyDerivedProduct < FHIR::Model
      ...
      METADATA = {
        ...
        '_id' => {'type'=>'Element', 'path'=>'BiologicallyDerivedProduct._id', 'min'=>0, 'max'=>1},
        ...
        '_implicitRules' => {'type'=>'Element', 'path'=>'BiologicallyDerivedProduct._implicitRules', 'min'=>0, 'max'=>1},
        ...
        '_language' => {'type'=>'Element', 'path'=>'BiologicallyDerivedProduct._language', 'min'=>0, 'max'=>1},
        ...
        '_productCategory' => {'type'=>'Element', 'path'=>'BiologicallyDerivedProduct._productCategory', 'min'=>0, 'max'=>1},
        ...
        '_status' => {'type'=>'Element', 'path'=>'BiologicallyDerivedProduct._status', 'min'=>0, 'max'=>1},
        ...
        '_quantity' => {'type'=>'Element', 'path'=>'BiologicallyDerivedProduct._quantity', 'min'=>0, 'max'=>1},
      ...
      class Collection < FHIR::Model
        ...
        METADATA = {
          ...
          '_id' => {'type'=>'Element', 'path'=>'Collection._id', 'min'=>0, 'max'=>1},
          ...
          '_collectedDateTime' => {'type'=>'Element', 'path'=>'Collection.collected[x]', 'min'=>0, 'max'=>1},
        ...
        attr_accessor :_collectedDateTime # 0-1 Element
      ...
      class Processing < FHIR::Model
        ...
        METADATA = {
          ...
          '_id' => {'type'=>'Element', 'path'=>'Processing._id', 'min'=>0, 'max'=>1},
          ...
          '_timeDateTime' => {'type'=>'Element', 'path'=>'Processing.time[x]', 'min'=>0, 'max'=>1},
        ...
        attr_accessor :_timeDateTime     # 0-1 Element
      ...
      class Manipulation < FHIR::Model
        ...
        METADATA = {
          ...
          '_id' => {'type'=>'Element', 'path'=>'Manipulation._id', 'min'=>0, 'max'=>1},
          ...
          '_description' => {'type'=>'Element', 'path'=>'Manipulation._description', 'min'=>0, 'max'=>1},
          'timeDateTime' => {'type'=>'dateTime', 'path'=>'Manipulation.time[x]', 'min'=>0, 'max'=>1},
          '_timeDateTime' => {'type'=>'Element', 'path'=>'Manipulation.time[x]', 'min'=>0, 'max'=>1},
      ...
      class Storage < FHIR::Model
        ...
        METADATA = {
          ...
          '_id' => {'type'=>'Element', 'path'=>'Storage._id', 'min'=>0, 'max'=>1},
          ...
          '_description' => {'type'=>'Element', 'path'=>'Storage._description', 'min'=>0, 'max'=>1},
          'temperature' => {'type'=>'decimal', 'path'=>'Storage.temperature', 'min'=>0, 'max'=>1},
          '_temperature' => {'type'=>'Element', 'path'=>'Storage._temperature', 'min'=>0, 'max'=>1},
          ...
          '_scale' => {'type'=>'Element', 'path'=>'Storage._scale', 'min'=>0, 'max'=>1},
        ...
        attr_accessor :_temperature      # 0-1 Element
        attr_accessor :scale             # 0-1 code
        attr_accessor :_scale            # 0-1 Element
      ...
      attr_accessor :_productCategory  # 0-1 Element
      ...
      attr_accessor :_quantity         # 0-1 Element
