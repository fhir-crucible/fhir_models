  ...
  module R4B
    class Communication < FHIR::Model
      ...
      METADATA = {
        ...
        '_implicitRules' => {'type'=>'Element', 'path'=>'Communication._implicitRules', 'min'=>0, 'max'=>1},
        ...
        '_language' => {'type'=>'Element', 'path'=>'Communication._language', 'min'=>0, 'max'=>1},
        ...
        '_instantiatesCanonical' => {'type'=>'Element', 'path'=>'Communication._instantiatesCanonical', 'min'=>0, 'max'=>Float::INFINITY},
        'instantiatesUri' => {'type'=>'uri', 'path'=>'Communication.instantiatesUri', 'min'=>0, 'max'=>Float::INFINITY},
        '_instantiatesUri' => {'type'=>'Element', 'path'=>'Communication._instantiatesUri', 'min'=>0, 'max'=>Float::INFINITY},
        ...
        '_status' => {'type'=>'Element', 'path'=>'Communication._status', 'min'=>0, 'max'=>1},
        ...
        '_priority' => {'type'=>'Element', 'path'=>'Communication._priority', 'min'=>0, 'max'=>1},
        ...
        '_sent' => {'type'=>'Element', 'path'=>'Communication._sent', 'min'=>0, 'max'=>1},
        'received' => {'type'=>'dateTime', 'path'=>'Communication.received', 'min'=>0, 'max'=>1},
        '_received' => {'type'=>'Element', 'path'=>'Communication._received', 'min'=>0, 'max'=>1},
      ...
      class Payload < FHIR::Model
        ...
        METADATA = {
          ...
          '_id' => {'type'=>'Element', 'path'=>'Payload._id', 'min'=>0, 'max'=>1},
          ...
          '_contentString' => {'type'=>'Element', 'path'=>'Payload.content[x]', 'min'=>0, 'max'=>1},
        ...
        attr_accessor :_contentString    # 0-1 Element
      ...
      attr_accessor :_sent                  # 0-1 Element
      attr_accessor :received               # 0-1 dateTime
      attr_accessor :_received              # 0-1 Element
