  ...
  module R4B
    class Ingredient < FHIR::Model
      ...
      METADATA = {
        ...
        '_implicitRules' => {'type'=>'Element', 'path'=>'Ingredient._implicitRules', 'min'=>0, 'max'=>1},
        'language' => {'valid_codes'=>{'urn:ietf:bcp:47'=>['ar', 'bn', 'cs', 'da', 'de', 'de-AT', 'de-CH', 'de-DE', 'el', 'en', 'en-AU', 'en-CA', 'en-GB', 'en-IN', 'en-NZ', 'en-SG', 'en-US', 'es', 'es-AR', 'es-ES', 'es-UY', 'fi', 'fr', 'fr-BE', 'fr-CH', 'fr-FR', 'fy', 'fy-NL', 'hi', 'hr', 'it', 'it-CH', 'it-IT', 'ja', 'ko', 'nl', 'nl-BE', 'nl-NL', 'no', 'no-NO', 'pa', 'pl', 'pt', 'pt-BR', 'ru', 'ru-RU', 'sr', 'sr-RS', 'sv', 'sv-SE', 'te', 'zh', 'zh-CN', 'zh-HK', 'zh-SG', 'zh-TW']}, 'type'=>'code', 'path'=>'Ingredient.language', 'min'=>0, 'max'=>1, 'binding'=>{'strength'=>'preferred', 'uri'=>'http://hl7.org/fhir/ValueSet/languages'}},
        '_language' => {'type'=>'Element', 'path'=>'Ingredient._language', 'min'=>0, 'max'=>1},
        ...
        '_status' => {'type'=>'Element', 'path'=>'Ingredient._status', 'min'=>0, 'max'=>1},
        ...
        '_allergenicIndicator' => {'type'=>'Element', 'path'=>'Ingredient._allergenicIndicator', 'min'=>0, 'max'=>1},
      ...
      class Manufacturer < FHIR::Model
        ...
        METADATA = {
          ...
          '_id' => {'type'=>'Element', 'path'=>'Manufacturer._id', 'min'=>0, 'max'=>1},
          ...
          '_role' => {'type'=>'Element', 'path'=>'Manufacturer._role', 'min'=>0, 'max'=>1},
      ...
      class Substance < FHIR::Model
        ...
        METADATA = {
          ...
          '_id' => {'type'=>'Element', 'path'=>'Substance._id', 'min'=>0, 'max'=>1},
        ...
        class Strength < FHIR::Model
          ...
          MULTIPLE_TYPES = {
            ...
            'concentration' => ['Ratio', 'RatioRange']
          }
          METADATA = {
            'id' => {'type'=>'string', 'path'=>'Strength.id', 'min'=>0, 'max'=>1},
            '_id' => {'type'=>'Element', 'path'=>'Strength._id', 'min'=>0, 'max'=>1},
            ...
            '_textPresentation' => {'type'=>'Element', 'path'=>'Strength._textPresentation', 'min'=>0, 'max'=>1},
            ...
            '_textConcentration' => {'type'=>'Element', 'path'=>'Strength._textConcentration', 'min'=>0, 'max'=>1},
            'measurementPoint' => {'type'=>'string', 'path'=>'Strength.measurementPoint', 'min'=>0, 'max'=>1},
            '_measurementPoint' => {'type'=>'Element', 'path'=>'Strength._measurementPoint', 'min'=>0, 'max'=>1},
          ...
          class ReferenceStrength < FHIR::Model
            ...
            METADATA = {
              ...
              '_id' => {'type'=>'Element', 'path'=>'ReferenceStrength._id', 'min'=>0, 'max'=>1},
              ...
              'substance' => {'type'=>'CodeableReference', 'path'=>'ReferenceStrength.substance', 'min'=>0, 'max'=>1},
              ...
              '_measurementPoint' => {'type'=>'Element', 'path'=>'ReferenceStrength._measurementPoint', 'min'=>0, 'max'=>1},
            ...
            attr_accessor :extension          # 0-* [ Extension ]
            attr_accessor :modifierExtension  # 0-* [ Extension ]
            attr_accessor :substance          # 0-1 CodeableReference
            ...
            attr_accessor :_measurementPoint  # 0-1 Element
          ...
          attr_accessor :_textPresentation       # 0-1 Element
          ...
          attr_accessor :_textConcentration      # 0-1 Element
          attr_accessor :measurementPoint        # 0-1 string
          attr_accessor :_measurementPoint       # 0-1 Element
          attr_accessor :country                 # 0-* [ CodeableConcept ]
