  ...
  module R4B
    class Device < FHIR::Model
      ...
      METADATA = {
        ...
        '_id' => {'type'=>'Element', 'path'=>'Device._id', 'min'=>0, 'max'=>1},
        'meta' => {'type'=>'Meta', 'path'=>'Device.meta', 'min'=>0, 'max'=>1},
        'implicitRules' => {'type'=>'uri', 'path'=>'Device.implicitRules', 'min'=>0, 'max'=>1},
        '_implicitRules' => {'type'=>'Element', 'path'=>'Device._implicitRules', 'min'=>0, 'max'=>1},
        ...
        '_language' => {'type'=>'Element', 'path'=>'Device._language', 'min'=>0, 'max'=>1},
        ...
        '_status' => {'type'=>'Element', 'path'=>'Device._status', 'min'=>0, 'max'=>1},
        ...
        '_distinctIdentifier' => {'type'=>'Element', 'path'=>'Device._distinctIdentifier', 'min'=>0, 'max'=>1},
        'manufacturer' => {'type'=>'string', 'path'=>'Device.manufacturer', 'min'=>0, 'max'=>1},
        '_manufacturer' => {'type'=>'Element', 'path'=>'Device._manufacturer', 'min'=>0, 'max'=>1},
        'manufactureDate' => {'type'=>'dateTime', 'path'=>'Device.manufactureDate', 'min'=>0, 'max'=>1},
        '_manufactureDate' => {'type'=>'Element', 'path'=>'Device._manufactureDate', 'min'=>0, 'max'=>1},
        'expirationDate' => {'type'=>'dateTime', 'path'=>'Device.expirationDate', 'min'=>0, 'max'=>1},
        '_expirationDate' => {'type'=>'Element', 'path'=>'Device._expirationDate', 'min'=>0, 'max'=>1},
        'lotNumber' => {'type'=>'string', 'path'=>'Device.lotNumber', 'min'=>0, 'max'=>1},
        '_lotNumber' => {'type'=>'Element', 'path'=>'Device._lotNumber', 'min'=>0, 'max'=>1},
        'serialNumber' => {'type'=>'string', 'path'=>'Device.serialNumber', 'min'=>0, 'max'=>1},
        '_serialNumber' => {'type'=>'Element', 'path'=>'Device._serialNumber', 'min'=>0, 'max'=>1},
        ...
        '_url' => {'type'=>'Element', 'path'=>'Device._url', 'min'=>0, 'max'=>1},
      ...
      class UdiCarrier < FHIR::Model
        ...
        METADATA = {
          ...
          '_id' => {'type'=>'Element', 'path'=>'UdiCarrier._id', 'min'=>0, 'max'=>1},
          ...
          '_deviceIdentifier' => {'type'=>'Element', 'path'=>'UdiCarrier._deviceIdentifier', 'min'=>0, 'max'=>1},
          'issuer' => {'type'=>'uri', 'path'=>'UdiCarrier.issuer', 'min'=>0, 'max'=>1},
          '_issuer' => {'type'=>'Element', 'path'=>'UdiCarrier._issuer', 'min'=>0, 'max'=>1},
          'jurisdiction' => {'type'=>'uri', 'path'=>'UdiCarrier.jurisdiction', 'min'=>0, 'max'=>1},
          '_jurisdiction' => {'type'=>'Element', 'path'=>'UdiCarrier._jurisdiction', 'min'=>0, 'max'=>1},
          'carrierAIDC' => {'type'=>'base64Binary', 'path'=>'UdiCarrier.carrierAIDC', 'min'=>0, 'max'=>1},
          '_carrierAIDC' => {'type'=>'Element', 'path'=>'UdiCarrier._carrierAIDC', 'min'=>0, 'max'=>1},
          'carrierHRF' => {'type'=>'string', 'path'=>'UdiCarrier.carrierHRF', 'min'=>0, 'max'=>1},
          '_carrierHRF' => {'type'=>'Element', 'path'=>'UdiCarrier._carrierHRF', 'min'=>0, 'max'=>1},
          ...
          '_entryType' => {'type'=>'Element', 'path'=>'UdiCarrier._entryType', 'min'=>0, 'max'=>1}
        }
        ...
        attr_accessor :_deviceIdentifier # 0-1 Element
        attr_accessor :issuer            # 0-1 uri
        attr_accessor :_issuer           # 0-1 Element
        attr_accessor :jurisdiction      # 0-1 uri
        attr_accessor :_jurisdiction     # 0-1 Element
        attr_accessor :carrierAIDC       # 0-1 base64Binary
        attr_accessor :_carrierAIDC      # 0-1 Element
        attr_accessor :carrierHRF        # 0-1 string
        attr_accessor :_carrierHRF       # 0-1 Element
        attr_accessor :entryType         # 0-1 code
        attr_accessor :_entryType        # 0-1 Element
      end
      ...
      class DeviceName < FHIR::Model
        ...
        METADATA = {
          ...
          '_id' => {'type'=>'Element', 'path'=>'DeviceName._id', 'min'=>0, 'max'=>1},
          ...
          '_name' => {'type'=>'Element', 'path'=>'DeviceName._name', 'min'=>0, 'max'=>1},
          ...
          '_type' => {'type'=>'Element', 'path'=>'DeviceName._type', 'min'=>0, 'max'=>1}
        }
      ...
      class Specialization < FHIR::Model
        ...
        METADATA = {
          ...
          '_id' => {'type'=>'Element', 'path'=>'Specialization._id', 'min'=>0, 'max'=>1},
          ...
          '_version' => {'type'=>'Element', 'path'=>'Specialization._version', 'min'=>0, 'max'=>1}
        }
      ...
      attr_accessor :_distinctIdentifier # 0-1 Element
      attr_accessor :manufacturer        # 0-1 string
      attr_accessor :_manufacturer       # 0-1 Element
      attr_accessor :manufactureDate     # 0-1 dateTime
      attr_accessor :_manufactureDate    # 0-1 Element
      attr_accessor :expirationDate      # 0-1 dateTime
      attr_accessor :_expirationDate     # 0-1 Element
      attr_accessor :lotNumber           # 0-1 string
      attr_accessor :_lotNumber          # 0-1 Element
      attr_accessor :serialNumber        # 0-1 string
      attr_accessor :_serialNumber       # 0-1 Element
      attr_accessor :deviceName          # 0-* [ Device::DeviceName ]
      attr_accessor :modelNumber         # 0-1 string
      attr_accessor :_modelNumber        # 0-1 Element
      attr_accessor :partNumber          # 0-1 string
      attr_accessor :_partNumber         # 0-1 Element
      attr_accessor :type                # 0-1 CodeableConcept
