  ...
  module R4B
    class Practitioner < FHIR::Model
      ...
      METADATA = {
        ...
        '_id' => {'type'=>'Element', 'path'=>'Practitioner._id', 'min'=>0, 'max'=>1},
        'meta' => {'type'=>'Meta', 'path'=>'Practitioner.meta', 'min'=>0, 'max'=>1},
        'implicitRules' => {'type'=>'uri', 'path'=>'Practitioner.implicitRules', 'min'=>0, 'max'=>1},
        '_implicitRules' => {'type'=>'Element', 'path'=>'Practitioner._implicitRules', 'min'=>0, 'max'=>1},
        ...
        '_language' => {'type'=>'Element', 'path'=>'Practitioner._language', 'min'=>0, 'max'=>1},
        ...
        '_active' => {'type'=>'Element', 'path'=>'Practitioner._active', 'min'=>0, 'max'=>1},
        ...
        '_gender' => {'type'=>'Element', 'path'=>'Practitioner._gender', 'min'=>0, 'max'=>1},
        'birthDate' => {'type'=>'date', 'path'=>'Practitioner.birthDate', 'min'=>0, 'max'=>1},
        '_birthDate' => {'type'=>'Element', 'path'=>'Practitioner._birthDate', 'min'=>0, 'max'=>1},
      ...
      class Qualification < FHIR::Model
        ...
        METADATA = {
          ...
          '_id' => {'type'=>'Element', 'path'=>'Qualification._id', 'min'=>0, 'max'=>1},
          ...
          'code' => {'type'=>'CodeableConcept', 'path'=>'Qualification.code', 'min'=>1, 'max'=>1, 'binding'=>{'strength'=>'example', 'uri'=>'http://terminology.hl7.org/ValueSet/v2-2.7-0360'}},
