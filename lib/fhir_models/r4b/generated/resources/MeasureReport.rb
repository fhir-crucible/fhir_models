  ...
  module R4B
    class MeasureReport < FHIR::Model
      ...
      METADATA = {
        ...
        '_id' => {'type'=>'Element', 'path'=>'MeasureReport._id', 'min'=>0, 'max'=>1},
        'meta' => {'type'=>'Meta', 'path'=>'MeasureReport.meta', 'min'=>0, 'max'=>1},
        'implicitRules' => {'type'=>'uri', 'path'=>'MeasureReport.implicitRules', 'min'=>0, 'max'=>1},
        '_implicitRules' => {'type'=>'Element', 'path'=>'MeasureReport._implicitRules', 'min'=>0, 'max'=>1},
        ...
        '_language' => {'type'=>'Element', 'path'=>'MeasureReport._language', 'min'=>0, 'max'=>1},
        ...
        '_status' => {'type'=>'Element', 'path'=>'MeasureReport._status', 'min'=>0, 'max'=>1},
        ...
        '_type' => {'type'=>'Element', 'path'=>'MeasureReport._type', 'min'=>0, 'max'=>1},
        'measure' => {'type'=>'canonical', 'path'=>'MeasureReport.measure', 'min'=>1, 'max'=>1},
        '_measure' => {'type'=>'Element', 'path'=>'MeasureReport._measure', 'min'=>0, 'max'=>1},
        ...
        '_date' => {'type'=>'Element', 'path'=>'MeasureReport._date', 'min'=>0, 'max'=>1},
      ...
      class Group < FHIR::Model
        ...
        class Population < FHIR::Model
          ...
          METADATA = {
            ...
            '_count' => {'type'=>'Element', 'path'=>'Population._count', 'min'=>0, 'max'=>1},
        ...
        class Stratifier < FHIR::Model
          ...
          METADATA = {
            ...
            'code' => {'valid_codes'=>{'http://terminology.hl7.org/CodeSystem/measure-stratifier-example'=>['age', 'gender', 'region']}, 'type'=>'CodeableConcept', 'path'=>'Stratifier.code', 'min'=>0, 'max'=>Float::INFINITY, 'binding'=>{'strength'=>'example', 'uri'=>'http://hl7.org/fhir/ValueSet/measure-stratifier-example'}},
          ...
          class Stratum < FHIR::Model
            ...
            METADATA = {
              ...
              '_id' => {'type'=>'Element', 'path'=>'Stratum._id', 'min'=>0, 'max'=>1},
              ...
              'value' => {'valid_codes'=>{'http://terminology.hl7.org/CodeSystem/measurereport-stratifier-value-example'=>['northwest', 'northeast', 'southwest', 'southeast']}, 'type'=>'CodeableConcept', 'path'=>'Stratum.value', 'min'=>0, 'max'=>1, 'binding'=>{'strength'=>'example', 'uri'=>'http://hl7.org/fhir/ValueSet/measurereport-stratifier-value-example'}},
            ...
            class Component < FHIR::Model
              ...
              METADATA = {
                ...
                'code' => {'valid_codes'=>{'http://terminology.hl7.org/CodeSystem/measure-stratifier-example'=>['age', 'gender', 'region']}, 'type'=>'CodeableConcept', 'path'=>'Component.code', 'min'=>1, 'max'=>1, 'binding'=>{'strength'=>'example', 'uri'=>'http://hl7.org/fhir/ValueSet/measure-stratifier-example'}},
                'value' => {'valid_codes'=>{'http://terminology.hl7.org/CodeSystem/measurereport-stratifier-value-example'=>['northwest', 'northeast', 'southwest', 'southeast']}, 'type'=>'CodeableConcept', 'path'=>'Component.value', 'min'=>1, 'max'=>1, 'binding'=>{'strength'=>'example', 'uri'=>'http://hl7.org/fhir/ValueSet/measurereport-stratifier-value-example'}}
              }
      ...
      attr_accessor :_measure            # 0-1 Element
