  ...
  module R4B
    class EnrollmentRequest < FHIR::Model
      ...
      METADATA = {
        ...
        '_id' => {'type'=>'Element', 'path'=>'EnrollmentRequest._id', 'min'=>0, 'max'=>1},
        ...
        '_implicitRules' => {'type'=>'Element', 'path'=>'EnrollmentRequest._implicitRules', 'min'=>0, 'max'=>1},
        ...
        '_language' => {'type'=>'Element', 'path'=>'EnrollmentRequest._language', 'min'=>0, 'max'=>1},
        ...
        '_status' => {'type'=>'Element', 'path'=>'EnrollmentRequest._status', 'min'=>0, 'max'=>1},
        'created' => {'type'=>'dateTime', 'path'=>'EnrollmentRequest.created', 'min'=>0, 'max'=>1},
        '_created' => {'type'=>'Element', 'path'=>'EnrollmentRequest._created', 'min'=>0, 'max'=>1},
