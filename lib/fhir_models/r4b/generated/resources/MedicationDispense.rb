  ...
  module R4B
    class MedicationDispense < FHIR::Model
      ...
      METADATA = {
        ...
        '_id' => {'type'=>'Element', 'path'=>'MedicationDispense._id', 'min'=>0, 'max'=>1},
        ...
        '_implicitRules' => {'type'=>'Element', 'path'=>'MedicationDispense._implicitRules', 'min'=>0, 'max'=>1},
        ...
        '_language' => {'type'=>'Element', 'path'=>'MedicationDispense._language', 'min'=>0, 'max'=>1},
        ...
        '_status' => {'type'=>'Element', 'path'=>'MedicationDispense._status', 'min'=>0, 'max'=>1},
        ...
        '_whenPrepared' => {'type'=>'Element', 'path'=>'MedicationDispense._whenPrepared', 'min'=>0, 'max'=>1},
        'whenHandedOver' => {'type'=>'dateTime', 'path'=>'MedicationDispense.whenHandedOver', 'min'=>0, 'max'=>1},
        '_whenHandedOver' => {'type'=>'Element', 'path'=>'MedicationDispense._whenHandedOver', 'min'=>0, 'max'=>1},
      ...
      class Substitution < FHIR::Model
        ...
        METADATA = {
          ...
          '_wasSubstituted' => {'type'=>'Element', 'path'=>'Substitution._wasSubstituted', 'min'=>0, 'max'=>1},
        ...
        attr_accessor :_wasSubstituted   # 0-1 Element
      ...
      attr_accessor :_whenPrepared               # 0-1 Element
      attr_accessor :whenHandedOver              # 0-1 dateTime
      attr_accessor :_whenHandedOver             # 0-1 Element
