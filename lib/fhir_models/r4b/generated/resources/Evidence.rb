module FHIR
  module R4B
    class Evidence < FHIR::Model
      ...
      SEARCH_PARAMS = ['context', 'context-quantity', 'context-type', 'date', 'description', 'identifier', 'publisher', 'status', 'title', 'url', 'version']
      METADATA = {
        'id' => {'type'=>'id', 'path'=>'Evidence.id', 'min'=>0, 'max'=>1},
        '_id' => {'type'=>'Element', 'path'=>'Ev_idence._id', 'min'=>0, 'max'=>1},
        'meta' => {'type'=>'Meta', 'path'=>'Evidence.meta', 'min'=>0, 'max'=>1},
        'implicitRules' => {'type'=>'uri', 'path'=>'Evidence.implicitRules', 'min'=>0, 'max'=>1},
        '_implicitRules' => {'type'=>'Element', 'path'=>'Evidence._implicitRules', 'min'=>0, 'max'=>1},
        ...
        '_language' => {'type'=>'Element', 'path'=>'Evidence._language', 'min'=>0, 'max'=>1},
        ...
        '_url' => {'type'=>'Element', 'path'=>'Evidence._url', 'min'=>0, 'max'=>1},
        ...
        '_version' => {'type'=>'Element', 'path'=>'Evidence._version', 'min'=>0, 'max'=>1},
        'title' => {'type'=>'string', 'path'=>'Evidence.title', 'min'=>0, 'max'=>1},
        '_title' => {'type'=>'Element', 'path'=>'Evidence._title', 'min'=>0, 'max'=>1},
        ...
        '_citeAsMarkdown' => {'type'=>'Element', 'path'=>'Evidence.citeAs[x]', 'min'=>0, 'max'=>1},
        ...
        '_status' => {'type'=>'Element', 'path'=>'Evidence._status', 'min'=>0, 'max'=>1},
        'date' => {'type'=>'dateTime', 'path'=>'Evidence.date', 'min'=>0, 'max'=>1},
        '_date' => {'type'=>'Element', 'path'=>'Evidence._date', 'min'=>0, 'max'=>1},
        ...
        '_approvalDate' => {'type'=>'Element', 'path'=>'Evidence._approvalDate', 'min'=>0, 'max'=>1},
        'lastReviewDate' => {'type'=>'date', 'path'=>'Evidence.lastReviewDate', 'min'=>0, 'max'=>1},
        '_lastReviewDate' => {'type'=>'Element', 'path'=>'Evidence._lastReviewDate', 'min'=>0, 'max'=>1},
        'publisher' => {'type'=>'string', 'path'=>'Evidence.publisher', 'min'=>0, 'max'=>1},
        '_publisher' => {'type'=>'Element', 'path'=>'Evidence._publisher', 'min'=>0, 'max'=>1},
        ...
        '_description' => {'type'=>'Element', 'path'=>'Evidence._description', 'min'=>0, 'max'=>1},
        'assertion' => {'type'=>'markdown', 'path'=>'Evidence.assertion', 'min'=>0, 'max'=>1},
        '_assertion' => {'type'=>'Element', 'path'=>'Evidence._assertion', 'min'=>0, 'max'=>1},
      ...
      class VariableDefinition < FHIR::Model
        ...
        METADATA = {
          ...
          '_id' => {'type'=>'Element', 'path'=>'VariableDefinition._id', 'min'=>0, 'max'=>1},
          ...
          '_description' => {'type'=>'Element', 'path'=>'VariableDefinition._description', 'min'=>0, 'max'=>1},
      ...
      class Statistic < FHIR::Model
        ...
        METADATA = {
          ...
          '_id' => {'type'=>'Element', 'path'=>'Statistic._id', 'min'=>0, 'max'=>1},
          ...
          '_description' => {'type'=>'Element', 'path'=>'Statistic._description', 'min'=>0, 'max'=>1},
          ...
          '_numberOfEvents' => {'type'=>'Element', 'path'=>'Statistic._numberOfEvents', 'min'=>0, 'max'=>1},
          'numberAffected' => {'type'=>'unsignedInt', 'path'=>'Statistic.numberAffected', 'min'=>0, 'max'=>1},
          '_numberAffected' => {'type'=>'Element', 'path'=>'Statistic._numberAffected', 'min'=>0, 'max'=>1},
        ...
        class SampleSize < FHIR::Model
          ...
          METADATA = {
            ...
            '_knownDataCount' => {'type'=>'Element', 'path'=>'SampleSize._knownDataCount', 'min'=>0, 'max'=>1}
          }
          ...
          attr_accessor :_knownDataCount       # 0-1 Element
        end
        ...
        class AttributeEstimate < FHIR::Model
          ...
          METADATA = {
            ...
            '_id' => {'type'=>'Element', 'path'=>'AttributeEstimate._id', 'min'=>0, 'max'=>1},
            ...
            '_description' => {'type'=>'Element', 'path'=>'AttributeEstimate._description', 'min'=>0, 'max'=>1},
            ...
            '_level' => {'type'=>'Element', 'path'=>'AttributeEstimate._level', 'min'=>0, 'max'=>1},
        ...
        class ModelCharacteristic < FHIR::Model
          ...
          METADATA = {
            ...
            '_id' => {'type'=>'Element', 'path'=>'ModelCharacteristic._id', 'min'=>0, 'max'=>1},
          ...
          class Variable < FHIR::Model
            ...
            METADATA = {
              ...
              '_handling' => {'type'=>'Element', 'path'=>'Variable._handling', 'min'=>0, 'max'=>1},
            ...
            attr_accessor :_handling          # 0-1 Element
        ...
        attr_accessor :_numberOfEvents     # 0-1 Element
        attr_accessor :numberAffected      # 0-1 unsignedInt
        attr_accessor :_numberAffected     # 0-1 Element
      ...
      class Certainty < FHIR::Model
        ...
        METADATA = {
          ...
          '_description' => {'type'=>'Element', 'path'=>'Certainty._description', 'min'=>0, 'max'=>1},
          ...
          '_rater' => {'type'=>'Element', 'path'=>'Certainty._rater', 'min'=>0, 'max'=>1},
        ...
        attr_accessor :_rater            # 0-1 Element
      ...
      attr_accessor :_citeAsMarkdown    # 0-1 Element
      ...
      attr_accessor :_assertion         # 0-1 Element
      attr_accessor :note               # 0-* [ Annotation ]
