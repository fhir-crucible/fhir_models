  ...
  module R4B
    class GuidanceResponse < FHIR::Model
      ...
      METADATA = {
        ...
        '_id' => {'type'=>'Element', 'path'=>'Gu_idanceResponse._id', 'min'=>0, 'max'=>1},
        ...
        '_implicitRules' => {'type'=>'Element', 'path'=>'GuidanceResponse._implicitRules', 'min'=>0, 'max'=>1},
        ...
        '_language' => {'type'=>'Element', 'path'=>'GuidanceResponse._language', 'min'=>0, 'max'=>1},
        ...
        '_moduleUri' => {'type'=>'Element', 'path'=>'GuidanceResponse.module[x]', 'min'=>0, 'max'=>1},
        'moduleCanonical' => {'type'=>'canonical', 'path'=>'GuidanceResponse.module[x]', 'min'=>1, 'max'=>1},
        '_moduleCanonical' => {'type'=>'Element', 'path'=>'GuidanceResponse.module[x]', 'min'=>0, 'max'=>1},
        ...
        '_status' => {'type'=>'Element', 'path'=>'GuidanceResponse._status', 'min'=>0, 'max'=>1},
        ...
        '_occurrenceDateTime' => {'type'=>'Element', 'path'=>'GuidanceResponse._occurrenceDateTime', 'min'=>0, 'max'=>1},
      ...
      attr_accessor :_moduleUri            # 0-1 Element
      attr_accessor :moduleCanonical       # 1-1 canonical
      attr_accessor :_moduleCanonical      # 0-1 Element
