  ...
  module R4B
    class MedicationKnowledge < FHIR::Model
      ...
      METADATA = {
        ...
        '_id' => {'type'=>'Element', 'path'=>'MedicationKnowledge._id', 'min'=>0, 'max'=>1},
        ...
        '_implicitRules' => {'type'=>'Element', 'path'=>'MedicationKnowledge._implicitRules', 'min'=>0, 'max'=>1},
        ...
        '_language' => {'type'=>'Element', 'path'=>'MedicationKnowledge._language', 'min'=>0, 'max'=>1},
        ...
        '_status' => {'type'=>'Element', 'path'=>'MedicationKnowledge._status', 'min'=>0, 'max'=>1},
        ...
        '_synonym' => {'type'=>'Element', 'path'=>'MedicationKnowledge._synonym', 'min'=>0, 'max'=>Float::INFINITY},
        ...
        '_preparationInstruction' => {'type'=>'Element', 'path'=>'MedicationKnowledge._preparationInstruction', 'min'=>0, 'max'=>1},
      ...
      class RelatedMedicationKnowledge < FHIR::Model
        ...
        METADATA = {
          ...
          '_id' => {'type'=>'Element', 'path'=>'RelatedMedicationKnowledge._id', 'min'=>0, 'max'=>1},
      ...
      class Monograph < FHIR::Model
        ...
        METADATA = {
          ...
          '_id' => {'type'=>'Element', 'path'=>'Monograph._id', 'min'=>0, 'max'=>1},
      ...
      class Ingredient < FHIR::Model
        ...
        METADATA = {
          ...
          '_id' => {'type'=>'Element', 'path'=>'Ingredient._id', 'min'=>0, 'max'=>1},
          ...
          '_isActive' => {'type'=>'Element', 'path'=>'Ingredient._isActive', 'min'=>0, 'max'=>1},
        ...
        attr_accessor :_isActive           # 0-1 Element
      ...
      class Cost < FHIR::Model
        ...
        METADATA = {
          ...
          '_id' => {'type'=>'Element', 'path'=>'Cost._id', 'min'=>0, 'max'=>1},
          ...
          '_source' => {'type'=>'Element', 'path'=>'Cost._source', 'min'=>0, 'max'=>1},
      ...
      class MonitoringProgram < FHIR::Model
        ...
        METADATA = {
          ...
          '_id' => {'type'=>'Element', 'path'=>'MonitoringProgram._id', 'min'=>0, 'max'=>1},
          ...
          '_name' => {'type'=>'Element', 'path'=>'MonitoringProgram._name', 'min'=>0, 'max'=>1}
        }
      ...
      class AdministrationGuidelines < FHIR::Model
        ...
        METADATA = {
          ...
          '_id' => {'type'=>'Element', 'path'=>'AdministrationGu_idelines._id', 'min'=>0, 'max'=>1},
        ...
        class Dosage < FHIR::Model
          ...
          METADATA = {
            ...
            '_id' => {'type'=>'Element', 'path'=>'Dosage._id', 'min'=>0, 'max'=>1},
        ...
        class PatientCharacteristics < FHIR::Model
          ...
          METADATA = {
            ...
            '_id' => {'type'=>'Element', 'path'=>'PatientCharacteristics._id', 'min'=>0, 'max'=>1},
            ...
            '_value' => {'type'=>'Element', 'path'=>'PatientCharacteristics._value', 'min'=>0, 'max'=>Float::INFINITY}
          }
          ...
          attr_accessor :_value                        # 0-* [ Element ]
        end
      ...
      class MedicineClassification < FHIR::Model
        ...
        METADATA = {
          ...
          '_id' => {'type'=>'Element', 'path'=>'MedicineClassification._id', 'min'=>0, 'max'=>1},
      ...
      class Packaging < FHIR::Model
        ...
        METADATA = {
          ...
          '_id' => {'type'=>'Element', 'path'=>'Packaging._id', 'min'=>0, 'max'=>1},
      ...
      class DrugCharacteristic < FHIR::Model
        ...
        METADATA = {
          ...
          '_id' => {'type'=>'Element', 'path'=>'DrugCharacteristic._id', 'min'=>0, 'max'=>1},
          ...
          '_valueString' => {'type'=>'Element', 'path'=>'DrugCharacteristic.value[x]', 'min'=>0, 'max'=>1},
          ...
          '_valueBase64Binary' => {'type'=>'Element', 'path'=>'DrugCharacteristic.value[x]', 'min'=>0, 'max'=>1}
        }
      ...
      class Regulatory < FHIR::Model
        ...
        METADATA = {
          ...
          '_id' => {'type'=>'Element', 'path'=>'Regulatory._id', 'min'=>0, 'max'=>1},
        ...
        class Substitution < FHIR::Model
          ...
          METADATA = {
            ...
            '_id' => {'type'=>'Element', 'path'=>'Substitution._id', 'min'=>0, 'max'=>1},
            ...
            '_allowed' => {'type'=>'Element', 'path'=>'Substitution._allowed', 'min'=>0, 'max'=>1}
          }
          ...
          attr_accessor :_allowed          # 0-1 Element
        end
        ...
        class Schedule < FHIR::Model
          ...
          METADATA = {
            ...
            '_id' => {'type'=>'Element', 'path'=>'Schedule._id', 'min'=>0, 'max'=>1},
        ...
        class MaxDispense < FHIR::Model
          ...
          METADATA = {
            ...
            '_id' => {'type'=>'Element', 'path'=>'MaxDispense._id', 'min'=>0, 'max'=>1},
      ...
      class Kinetics < FHIR::Model
        ...
        METADATA = {
          ...
          '_id' => {'type'=>'Element', 'path'=>'Kinetics._id', 'min'=>0, 'max'=>1},
      ...
      attr_accessor :_synonym                   # 0-* [ Element ]
      ...
      attr_accessor :_preparationInstruction    # 0-1 Element
