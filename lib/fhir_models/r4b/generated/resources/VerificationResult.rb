  ...
  module R4B
    class VerificationResult < FHIR::Model
      ...
      METADATA = {
        ...
        '_id' => {'type'=>'Element', 'path'=>'VerificationResult._id', 'min'=>0, 'max'=>1},
        ...
        '_implicitRules' => {'type'=>'Element', 'path'=>'VerificationResult._implicitRules', 'min'=>0, 'max'=>1},
        ...
        '_language' => {'type'=>'Element', 'path'=>'VerificationResult._language', 'min'=>0, 'max'=>1},
        ...
        '_targetLocation' => {'type'=>'Element', 'path'=>'VerificationResult._targetLocation', 'min'=>0, 'max'=>Float::INFINITY},
        ...
        'status' => {'valid_codes'=>{'http://hl7.org/fhir/verificationresult-status'=>['attested', 'validated', 'in-process', 'req-revalid', 'val-fail', 'reval-fail']}, 'type'=>'code', 'path'=>'VerificationResult.status', 'min'=>1, 'max'=>1, 'binding'=>{'strength'=>'required', 'uri'=>'http://hl7.org/fhir/ValueSet/verificationresult-status'}},
        '_status' => {'type'=>'Element', 'path'=>'VerificationResult._status', 'min'=>0, 'max'=>1},
        'statusDate' => {'type'=>'dateTime', 'path'=>'VerificationResult.statusDate', 'min'=>0, 'max'=>1},
        '_statusDate' => {'type'=>'Element', 'path'=>'VerificationResult._statusDate', 'min'=>0, 'max'=>1},
        ...
        '_lastPerformed' => {'type'=>'Element', 'path'=>'VerificationResult._lastPerformed', 'min'=>0, 'max'=>1},
        'nextScheduled' => {'type'=>'date', 'path'=>'VerificationResult.nextScheduled', 'min'=>0, 'max'=>1},
        '_nextScheduled' => {'type'=>'Element', 'path'=>'VerificationResult._nextScheduled', 'min'=>0, 'max'=>1},
      ...
      class PrimarySource < FHIR::Model
        ...
        METADATA = {
          ...
          '_id' => {'type'=>'Element', 'path'=>'PrimarySource._id', 'min'=>0, 'max'=>1},
          ...
          '_validationDate' => {'type'=>'Element', 'path'=>'PrimarySource._validationDate', 'min'=>0, 'max'=>1},
        ...
        attr_accessor :_validationDate     # 0-1 Element
      ...
      class Attestation < FHIR::Model
        ...
        METADATA = {
          ...
          '_id' => {'type'=>'Element', 'path'=>'Attestation._id', 'min'=>0, 'max'=>1},
          ...
          '_date' => {'type'=>'Element', 'path'=>'Attestation._date', 'min'=>0, 'max'=>1},
          'sourceIdentityCertificate' => {'type'=>'string', 'path'=>'Attestation.sourceIdentityCertificate', 'min'=>0, 'max'=>1},
          '_sourceIdentityCertificate' => {'type'=>'Element', 'path'=>'Attestation._sourceIdentityCertificate', 'min'=>0, 'max'=>1},
          'proxyIdentityCertificate' => {'type'=>'string', 'path'=>'Attestation.proxyIdentityCertificate', 'min'=>0, 'max'=>1},
          '_proxyIdentityCertificate' => {'type'=>'Element', 'path'=>'Attestation._proxyIdentityCertificate', 'min'=>0, 'max'=>1},
        ...
        attr_accessor :_sourceIdentityCertificate # 0-1 Element
        attr_accessor :proxyIdentityCertificate   # 0-1 string
        attr_accessor :_proxyIdentityCertificate  # 0-1 Element
      ...
      class Validator < FHIR::Model
        ...
        METADATA = {
          ...
          '_id' => {'type'=>'Element', 'path'=>'Val_idator._id', 'min'=>0, 'max'=>1},
          ...
          '_identityCertificate' => {'type'=>'Element', 'path'=>'Validator._identityCertificate', 'min'=>0, 'max'=>1},
        ...
        attr_accessor :_identityCertificate # 0-1 Element
      ...
      attr_accessor :_targetLocation   # 0-* [ Element ]
      ...
      attr_accessor :_lastPerformed    # 0-1 Element
      attr_accessor :nextScheduled     # 0-1 date
      attr_accessor :_nextScheduled    # 0-1 Element
