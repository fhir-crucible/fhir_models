  ...
  module R4B
    class AuditEvent < FHIR::Model
      ...
      METADATA = {
        ...
        '_id' => {'type'=>'Element', 'path'=>'AuditEvent._id', 'min'=>0, 'max'=>1},
        'meta' => {'type'=>'Meta', 'path'=>'AuditEvent.meta', 'min'=>0, 'max'=>1},
        'implicitRules' => {'type'=>'uri', 'path'=>'AuditEvent.implicitRules', 'min'=>0, 'max'=>1},
        '_implicitRules' => {'type'=>'Element', 'path'=>'AuditEvent._implicitRules', 'min'=>0, 'max'=>1},
        ...
        '_language' => {'type'=>'Element', 'path'=>'AuditEvent._language', 'min'=>0, 'max'=>1},
        ...
        '_action' => {'type'=>'Element', 'path'=>'AuditEvent._action', 'min'=>0, 'max'=>1},
        'period' => {'type'=>'Period', 'path'=>'AuditEvent.period', 'min'=>0, 'max'=>1},
        'recorded' => {'type'=>'instant', 'path'=>'AuditEvent.recorded', 'min'=>1, 'max'=>1},
        '_recorded' => {'type'=>'Element', 'path'=>'AuditEvent._recorded', 'min'=>0, 'max'=>1},
        ...
        '_outcome' => {'type'=>'Element', 'path'=>'AuditEvent._outcome', 'min'=>0, 'max'=>1},
        'outcomeDesc' => {'type'=>'string', 'path'=>'AuditEvent.outcomeDesc', 'min'=>0, 'max'=>1},
        '_outcomeDesc' => {'type'=>'Element', 'path'=>'AuditEvent._outcomeDesc', 'min'=>0, 'max'=>1},
      ...
      class Agent < FHIR::Model
        ...
        METADATA = {
          ...
          '_id' => {'type'=>'Element', 'path'=>'Agent._id', 'min'=>0, 'max'=>1},
          ...
          '_altId' => {'type'=>'Element', 'path'=>'Agent._altId', 'min'=>0, 'max'=>1},
          'name' => {'type'=>'string', 'path'=>'Agent.name', 'min'=>0, 'max'=>1},
          '_name' => {'type'=>'Element', 'path'=>'Agent._name', 'min'=>0, 'max'=>1},
          'requestor' => {'type'=>'boolean', 'path'=>'Agent.requestor', 'min'=>1, 'max'=>1},
          '_requestor' => {'type'=>'Element', 'path'=>'Agent._requestor', 'min'=>0, 'max'=>1},
          ...
          '_policy' => {'type'=>'Element', 'path'=>'Agent._policy', 'min'=>0, 'max'=>Float::INFINITY},
        ...
        class Network < FHIR::Model
          ...
          METADATA = {
            ...
            '_id' => {'type'=>'Element', 'path'=>'Network._id', 'min'=>0, 'max'=>1},
            ...
            '_address' => {'type'=>'Element', 'path'=>'Network._address', 'min'=>0, 'max'=>1},
            ...
            '_type' => {'type'=>'Element', 'path'=>'Network._type', 'min'=>0, 'max'=>1}
          }
      ...
      class Source < FHIR::Model
        ...
        METADATA = {
          ...
          '_site' => {'type'=>'Element', 'path'=>'Source._site', 'min'=>0, 'max'=>1},
        ...
        attr_accessor :_site             # 0-1 Element
      ...
      class Entity < FHIR::Model
        ...
        METADATA = {
          ...
          '_id' => {'type'=>'Element', 'path'=>'Entity._id', 'min'=>0, 'max'=>1},
          ...
          '_name' => {'type'=>'Element', 'path'=>'Entity._name', 'min'=>0, 'max'=>1},
          'description' => {'type'=>'string', 'path'=>'Entity.description', 'min'=>0, 'max'=>1},
          '_description' => {'type'=>'Element', 'path'=>'Entity._description', 'min'=>0, 'max'=>1},
          'query' => {'type'=>'base64Binary', 'path'=>'Entity.query', 'min'=>0, 'max'=>1},
          '_query' => {'type'=>'Element', 'path'=>'Entity._query', 'min'=>0, 'max'=>1},
        ...
        class Detail < FHIR::Model
          ...
          METADATA = {
            ...
            '_type' => {'type'=>'Element', 'path'=>'Detail._type', 'min'=>0, 'max'=>1},
            'valueString' => {'type'=>'string', 'path'=>'Detail.value[x]', 'min'=>1, 'max'=>1},
            '_valueString' => {'type'=>'Element', 'path'=>'Detail.value[x]', 'min'=>0, 'max'=>1},
            'valueBase64Binary' => {'type'=>'base64Binary', 'path'=>'Detail.value[x]', 'min'=>1, 'max'=>1},
            '_valueBase64Binary' => {'type'=>'Element', 'path'=>'Detail.value[x]', 'min'=>0, 'max'=>1}
          }
        ...
        attr_accessor :_query            # 0-1 Element
      ...
      attr_accessor :_action           # 0-1 Element
      ...
      attr_accessor :_outcomeDesc      # 0-1 Element
