  ...
  module R4B
    class ImmunizationEvaluation < FHIR::Model
      ...
      METADATA = {
        ...
        '_id' => {'type'=>'Element', 'path'=>'ImmunizationEvaluation._id', 'min'=>0, 'max'=>1},
        ...
        '_implicitRules' => {'type'=>'Element', 'path'=>'ImmunizationEvaluation._implicitRules', 'min'=>0, 'max'=>1},
        ...
        '_language' => {'type'=>'Element', 'path'=>'ImmunizationEvaluation._language', 'min'=>0, 'max'=>1},
        ...
        '_status' => {'type'=>'Element', 'path'=>'ImmunizationEvaluation._status', 'min'=>0, 'max'=>1},
        ...
        '_date' => {'type'=>'Element', 'path'=>'ImmunizationEvaluation._date', 'min'=>0, 'max'=>1},
        ...
        '_description' => {'type'=>'Element', 'path'=>'ImmunizationEvaluation._description', 'min'=>0, 'max'=>1},
        'series' => {'type'=>'string', 'path'=>'ImmunizationEvaluation.series', 'min'=>0, 'max'=>1},
        '_series' => {'type'=>'Element', 'path'=>'ImmunizationEvaluation._series', 'min'=>0, 'max'=>1},
        'doseNumberPositiveInt' => {'type'=>'positiveInt', 'path'=>'ImmunizationEvaluation.doseNumber[x]', 'min'=>0, 'max'=>1},
        '_doseNumberPositiveInt' => {'type'=>'Element', 'path'=>'ImmunizationEvaluation.doseNumber[x]', 'min'=>0, 'max'=>1},
        'doseNumberString' => {'type'=>'string', 'path'=>'ImmunizationEvaluation.doseNumber[x]', 'min'=>0, 'max'=>1},
        '_doseNumberString' => {'type'=>'Element', 'path'=>'ImmunizationEvaluation.doseNumber[x]', 'min'=>0, 'max'=>1},
        'seriesDosesPositiveInt' => {'type'=>'positiveInt', 'path'=>'ImmunizationEvaluation.seriesDoses[x]', 'min'=>0, 'max'=>1},
        '_seriesDosesPositiveInt' => {'type'=>'Element', 'path'=>'ImmunizationEvaluation.seriesDoses[x]', 'min'=>0, 'max'=>1},
        'seriesDosesString' => {'type'=>'string', 'path'=>'ImmunizationEvaluation.seriesDoses[x]', 'min'=>0, 'max'=>1},
        '_seriesDosesString' => {'type'=>'Element', 'path'=>'ImmunizationEvaluation.seriesDoses[x]', 'min'=>0, 'max'=>1}
      }
