  ...
  module R4B
    class ManufacturedItemDefinition < FHIR::Model
      ...
      METADATA = {
        ...
        '_id' => {'type'=>'Element', 'path'=>'ManufacturedItemDefinition._id', 'min'=>0, 'max'=>1},
        ...
        '_implicitRules' => {'type'=>'Element', 'path'=>'ManufacturedItemDefinition._implicitRules', 'min'=>0, 'max'=>1},
        ...
        '_language' => {'type'=>'Element', 'path'=>'ManufacturedItemDefinition._language', 'min'=>0, 'max'=>1},
        ...
        '_status' => {'type'=>'Element', 'path'=>'ManufacturedItemDefinition._status', 'min'=>0, 'max'=>1},
