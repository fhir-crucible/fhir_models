  ...
  module R4B
    class SubstanceDefinition < FHIR::Model
      ...
      METADATA = {
        ...
        '_id' => {'type'=>'Element', 'path'=>'SubstanceDefinition._id', 'min'=>0, 'max'=>1},
        ...
        '_implicitRules' => {'type'=>'Element', 'path'=>'SubstanceDefinition._implicitRules', 'min'=>0, 'max'=>1},
        ...
        '_language' => {'type'=>'Element', 'path'=>'SubstanceDefinition._language', 'min'=>0, 'max'=>1},
        ...
        '_version' => {'type'=>'Element', 'path'=>'SubstanceDefinition._version', 'min'=>0, 'max'=>1},
        ...
        '_description' => {'type'=>'Element', 'path'=>'SubstanceDefinition._description', 'min'=>0, 'max'=>1},
      ...
      class Property < FHIR::Model
        ...
        METADATA = {
          ...
          '_valueDate' => {'type'=>'Element', 'path'=>'Property.value[x]', 'min'=>0, 'max'=>1},
      ...
      class SourceMaterial < FHIR::Model
        ...
        METADATA = {
          ...
          '_id' => {'type'=>'Element', 'path'=>'SourceMaterial._id', 'min'=>0, 'max'=>1},
