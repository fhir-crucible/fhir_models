  ...
  module R4B
    class CommunicationRequest < FHIR::Model
      ...
      METADATA = {
        ...
        '_id' => {'type'=>'Element', 'path'=>'CommunicationRequest._id', 'min'=>0, 'max'=>1},
        ...
        '_implicitRules' => {'type'=>'Element', 'path'=>'CommunicationRequest._implicitRules', 'min'=>0, 'max'=>1},
        ...
        '_language' => {'type'=>'Element', 'path'=>'CommunicationRequest._language', 'min'=>0, 'max'=>1},
        ...
        '_status' => {'type'=>'Element', 'path'=>'CommunicationRequest._status', 'min'=>0, 'max'=>1},
        ...
        '_priority' => {'type'=>'Element', 'path'=>'CommunicationRequest._priority', 'min'=>0, 'max'=>1},
        'doNotPerform' => {'type'=>'boolean', 'path'=>'CommunicationRequest.doNotPerform', 'min'=>0, 'max'=>1},
        '_doNotPerform' => {'type'=>'Element', 'path'=>'CommunicationRequest._doNotPerform', 'min'=>0, 'max'=>1},
        ...
        '_occurrenceDateTime' => {'type'=>'Element', 'path'=>'CommunicationRequest.occurrence[x]', 'min'=>0, 'max'=>1},
        ...
        '_authoredOn' => {'type'=>'Element', 'path'=>'CommunicationRequest._authoredOn', 'min'=>0, 'max'=>1},
