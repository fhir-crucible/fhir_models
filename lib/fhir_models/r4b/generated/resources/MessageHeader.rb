  ...
  module R4B
    class MessageHeader < FHIR::Model
      ...
      METADATA = {
        ...
        '_id' => {'type'=>'Element', 'path'=>'MessageHeader._id', 'min'=>0, 'max'=>1},
        'meta' => {'type'=>'Meta', 'path'=>'MessageHeader.meta', 'min'=>0, 'max'=>1},
        'implicitRules' => {'type'=>'uri', 'path'=>'MessageHeader.implicitRules', 'min'=>0, 'max'=>1},
        '_implicitRules' => {'type'=>'Element', 'path'=>'MessageHeader._implicitRules', 'min'=>0, 'max'=>1},
        ...
        '_language' => {'type'=>'Element', 'path'=>'MessageHeader._language', 'min'=>0, 'max'=>1},
        ...
        '_eventUri' => {'type'=>'Element', 'path'=>'MessageHeader.event[x]', 'min'=>0, 'max'=>1},
        ...
        '_definition' => {'type'=>'Element', 'path'=>'MessageHeader._definition', 'min'=>0, 'max'=>1}
      }
      ...
      class Destination < FHIR::Model
        ...
        METADATA = {
          ...
          '_name' => {'type'=>'Element', 'path'=>'Destination._name', 'min'=>0, 'max'=>1},
          ...
          '_endpoint' => {'type'=>'Element', 'path'=>'Destination._endpoint', 'min'=>0, 'max'=>1},
      ...
      class Source < FHIR::Model
        ...
        METADATA = {
          ...
          '_name' => {'type'=>'Element', 'path'=>'Source._name', 'min'=>0, 'max'=>1},
          'software' => {'type'=>'string', 'path'=>'Source.software', 'min'=>0, 'max'=>1},
          '_software' => {'type'=>'Element', 'path'=>'Source._software', 'min'=>0, 'max'=>1},
          'version' => {'type'=>'string', 'path'=>'Source.version', 'min'=>0, 'max'=>1},
          '_version' => {'type'=>'Element', 'path'=>'Source._version', 'min'=>0, 'max'=>1},
          'contact' => {'type'=>'ContactPoint', 'path'=>'Source.contact', 'min'=>0, 'max'=>1},
          'endpoint' => {'type'=>'url', 'path'=>'Source.endpoint', 'min'=>1, 'max'=>1},
          '_endpoint' => {'type'=>'Element', 'path'=>'Source._endpoint', 'min'=>0, 'max'=>1}
        }
        ...
        attr_accessor :_software         # 0-1 Element
      ...
      class Response < FHIR::Model
        ...
        METADATA = {
          ...
          '_identifier' => {'type'=>'Element', 'path'=>'Response._identifier', 'min'=>0, 'max'=>1},
          ...
          '_code' => {'type'=>'Element', 'path'=>'Response._code', 'min'=>0, 'max'=>1},
