  ...
  module R4B
    class CatalogEntry < FHIR::Model
      ...
      METADATA = {
        ...
        '_id' => {'type'=>'Element', 'path'=>'CatalogEntry._id', 'min'=>0, 'max'=>1},
        'meta' => {'type'=>'Meta', 'path'=>'CatalogEntry.meta', 'min'=>0, 'max'=>1},
        'implicitRules' => {'type'=>'uri', 'path'=>'CatalogEntry.implicitRules', 'min'=>0, 'max'=>1},
        '_implicitRules' => {'type'=>'Element', 'path'=>'CatalogEntry._implicitRules', 'min'=>0, 'max'=>1},
        ...
        '_language' => {'type'=>'Element', 'path'=>'CatalogEntry._language', 'min'=>0, 'max'=>1},
        ...
        '_orderable' => {'type'=>'Element', 'path'=>'CatalogEntry._orderable', 'min'=>0, 'max'=>1},
        ...
        '_status' => {'type'=>'Element', 'path'=>'CatalogEntry._status', 'min'=>0, 'max'=>1},
        ...
        '_validTo' => {'type'=>'Element', 'path'=>'CatalogEntry._validTo', 'min'=>0, 'max'=>1},
        'lastUpdated' => {'type'=>'dateTime', 'path'=>'CatalogEntry.lastUpdated', 'min'=>0, 'max'=>1},
        '_lastUpdated' => {'type'=>'Element', 'path'=>'CatalogEntry._lastUpdated', 'min'=>0, 'max'=>1},
      ...
      class RelatedEntry < FHIR::Model
        ...
        METADATA = {
          ...
          '_id' => {'type'=>'Element', 'path'=>'RelatedEntry._id', 'min'=>0, 'max'=>1},
          ...
          '_relationtype' => {'type'=>'Element', 'path'=>'RelatedEntry._relationtype', 'min'=>0, 'max'=>1},
        ...
        attr_accessor :_relationtype     # 0-1 Element
      ...
      attr_accessor :_orderable               # 0-1 Element
      ...
      attr_accessor :_validTo                 # 0-1 Element
