  ...
  module R4B
    class SubscriptionStatus < FHIR::Model
      ...
      METADATA = {
        ...
        '_id' => {'type'=>'Element', 'path'=>'SubscriptionStatus._id', 'min'=>0, 'max'=>1},
        ...
        '_implicitRules' => {'type'=>'Element', 'path'=>'SubscriptionStatus._implicitRules', 'min'=>0, 'max'=>1},
        ...
        '_language' => {'type'=>'Element', 'path'=>'SubscriptionStatus._language', 'min'=>0, 'max'=>1},
        ...
        '_status' => {'type'=>'Element', 'path'=>'SubscriptionStatus._status', 'min'=>0, 'max'=>1},
        ...
        '_type' => {'type'=>'Element', 'path'=>'SubscriptionStatus._type', 'min'=>0, 'max'=>1},
        'eventsSinceSubscriptionStart' => {'type'=>'string', 'path'=>'SubscriptionStatus.eventsSinceSubscriptionStart', 'min'=>0, 'max'=>1},
        '_eventsSinceSubscriptionStart' => {'type'=>'Element', 'path'=>'SubscriptionStatus._eventsSinceSubscriptionStart', 'min'=>0, 'max'=>1},
        ...
        '_topic' => {'type'=>'Element', 'path'=>'SubscriptionStatus._topic', 'min'=>0, 'max'=>1},
      ...
      class NotificationEvent < FHIR::Model
        ...
        METADATA = {
          ...
          '_id' => {'type'=>'Element', 'path'=>'NotificationEvent._id', 'min'=>0, 'max'=>1},
          ...
          '_eventNumber' => {'type'=>'Element', 'path'=>'NotificationEvent._eventNumber', 'min'=>0, 'max'=>1},
          'timestamp' => {'type'=>'instant', 'path'=>'NotificationEvent.timestamp', 'min'=>0, 'max'=>1},
          '_timestamp' => {'type'=>'Element', 'path'=>'NotificationEvent._timestamp', 'min'=>0, 'max'=>1},
        ...
        attr_accessor :_eventNumber      # 0-1 Element
      ...
      attr_accessor :_eventsSinceSubscriptionStart # 0-1 Element
      ...
      attr_accessor :_topic                        # 0-1 Element
