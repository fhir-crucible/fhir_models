  ...
  module R4B
    class ClinicalUseDefinition < FHIR::Model
      ...
      METADATA = {
        ...
        '_id' => {'type'=>'Element', 'path'=>'ClinicalUseDefinition._id', 'min'=>0, 'max'=>1},
        ...
        '_implicitRules' => {'type'=>'Element', 'path'=>'ClinicalUseDefinition._implicitRules', 'min'=>0, 'max'=>1},
        ...
        '_language' => {'type'=>'Element', 'path'=>'ClinicalUseDefinition._language', 'min'=>0, 'max'=>1},
        ...
        '_type' => {'type'=>'Element', 'path'=>'ClinicalUseDefinition._type', 'min'=>0, 'max'=>1},
      ...
      class Contraindication < FHIR::Model
        ...
        METADATA = {
          ...
          '_id' => {'type'=>'Element', 'path'=>'Contraindication._id', 'min'=>0, 'max'=>1},
      ...
      class Indication < FHIR::Model
        ...
        METADATA = {
          ...
          '_id' => {'type'=>'Element', 'path'=>'Indication._id', 'min'=>0, 'max'=>1},
          ...
          '_durationString' => {'type'=>'Element', 'path'=>'Indication.duration[x]', 'min'=>0, 'max'=>1},
        ...
        attr_accessor :_durationString         # 0-1 Element
      ...
      class UndesirableEffect < FHIR::Model
        ...
        METADATA = {
          ...
          '_id' => {'type'=>'Element', 'path'=>'UndesirableEffect._id', 'min'=>0, 'max'=>1},
      ...
      class Warning < FHIR::Model
        ...
        METADATA = {
          ...
          '_id' => {'type'=>'Element', 'path'=>'Warning._id', 'min'=>0, 'max'=>1},
          ...
          '_description' => {'type'=>'Element', 'path'=>'Warning._description', 'min'=>0, 'max'=>1},
