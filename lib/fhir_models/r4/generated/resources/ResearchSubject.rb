module FHIR
  module R4
    class ResearchSubject < FHIR::Model
      ...
      METADATA = {
        ...
        '_id' => {'type'=>'Element', 'path'=>'ResearchSubject._id', 'min'=>0, 'max'=>1},
        ...
        '_implicitRules' => {'type'=>'Element', 'path'=>'ResearchSubject._implicitRules', 'min'=>0, 'max'=>1},
        ...
        '_language' => {'type'=>'Element', 'path'=>'ResearchSubject._language', 'min'=>0, 'max'=>1},
        ...
        '_status' => {'type'=>'Element', 'path'=>'ResearchSubject._status', 'min'=>0, 'max'=>1},
        ...
        '_assignedArm' => {'type'=>'Element', 'path'=>'ResearchSubject._assignedArm', 'min'=>0, 'max'=>1},
        'actualArm' => {'type'=>'string', 'path'=>'ResearchSubject.actualArm', 'min'=>0, 'max'=>1},
        '_actualArm' => {'type'=>'Element', 'path'=>'ResearchSubject._actualArm', 'min'=>0, 'max'=>1},
      ...
      attr_accessor :_assignedArm      # 0-1 Element
      attr_accessor :actualArm         # 0-1 string
      attr_accessor :_actualArm        # 0-1 Element
  ...
  ResearchSubject = FHIR::R4::ResearchSubject
end