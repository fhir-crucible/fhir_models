module FHIR
  module R4
    class NutritionOrder < FHIR::Model
      ...
      METADATA = {
        ...
        '_id' => {'type'=>'Element', 'path'=>'NutritionOrder._id', 'min'=>0, 'max'=>1},
        'meta' => {'type'=>'Meta', 'path'=>'NutritionOrder.meta', 'min'=>0, 'max'=>1},
        'implicitRules' => {'type'=>'uri', 'path'=>'NutritionOrder.implicitRules', 'min'=>0, 'max'=>1},
        '_implicitRules' => {'type'=>'Element', 'path'=>'NutritionOrder._implicitRules', 'min'=>0, 'max'=>1},
        ...
        '_language' => {'type'=>'Element', 'path'=>'NutritionOrder._language', 'min'=>0, 'max'=>1},
        ...
        '_instantiatesCanonical' => {'type'=>'Element', 'path'=>'NutritionOrder._instantiatesCanonical', 'min'=>0, 'max'=>Float::INFINITY},
        'instantiatesUri' => {'type'=>'uri', 'path'=>'NutritionOrder.instantiatesUri', 'min'=>0, 'max'=>Float::INFINITY},
        '_instantiatesUri' => {'type'=>'Element', 'path'=>'NutritionOrder._instantiatesUri', 'min'=>0, 'max'=>Float::INFINITY},
        'instantiates' => {'type'=>'uri', 'path'=>'NutritionOrder.instantiates', 'min'=>0, 'max'=>Float::INFINITY},
        '_instantiates' => {'type'=>'Element', 'path'=>'NutritionOrder._instantiates', 'min'=>0, 'max'=>Float::INFINITY},
        ...
        '_status' => {'type'=>'Element', 'path'=>'NutritionOrder._status', 'min'=>0, 'max'=>1},
        ...
        '_intent' => {'type'=>'Element', 'path'=>'NutritionOrder._intent', 'min'=>0, 'max'=>1},
        ...
        '_dateTime' => {'type'=>'Element', 'path'=>'NutritionOrder._dateTime', 'min'=>0, 'max'=>1},
      ...
      class OralDiet < FHIR::Model
        ...
        METADATA = {
          ...
          '_id' => {'type'=>'Element', 'path'=>'OralDiet._id', 'min'=>0, 'max'=>1},
          ...
          '_instruction' => {'type'=>'Element', 'path'=>'OralDiet._instruction', 'min'=>0, 'max'=>1}
        }
        ...
        class Texture < FHIR::Model
          ...
          METADATA = {
            ...
            '_id' => {'type'=>'Element', 'path'=>'Texture._id', 'min'=>0, 'max'=>1},
      ...
      class Supplement < FHIR::Model
        ...
        METADATA = {
          ...
          '_id' => {'type'=>'Element', 'path'=>'Supplement._id', 'min'=>0, 'max'=>1},
          ...
          '_productName' => {'type'=>'Element', 'path'=>'Supplement._productName', 'min'=>0, 'max'=>1},
          ...
          '_instruction' => {'type'=>'Element', 'path'=>'Supplement._instruction', 'min'=>0, 'max'=>1}
        }
      ...
      class EnteralFormula < FHIR::Model
        ...
        METADATA = {
          ...
          '_id' => {'type'=>'Element', 'path'=>'EnteralFormula._id', 'min'=>0, 'max'=>1},
          ...
          '_baseFormulaProductName' => {'type'=>'Element', 'path'=>'EnteralFormula._baseFormulaProductName', 'min'=>0, 'max'=>1},
          ...
          '_additiveProductName' => {'type'=>'Element', 'path'=>'EnteralFormula._additiveProductName', 'min'=>0, 'max'=>1},
          ...
          '_administrationInstruction' => {'type'=>'Element', 'path'=>'EnteralFormula._administrationInstruction', 'min'=>0, 'max'=>1}
        }
        ...
        class Administration < FHIR::Model
          ...
          METADATA = {
            ...
            '_id' => {'type'=>'Element', 'path'=>'Administration._id', 'min'=>0, 'max'=>1},
        ...
        attr_accessor :_baseFormulaProductName    # 0-1 Element
        attr_accessor :additiveType               # 0-1 CodeableConcept
        attr_accessor :additiveProductName        # 0-1 string
        attr_accessor :_additiveProductName       # 0-1 Element
        ...
        attr_accessor :_administrationInstruction # 0-1 Element
      end
  ...
  NutritionOrder = FHIR::R4::NutritionOrder
end