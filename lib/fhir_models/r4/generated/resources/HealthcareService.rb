module FHIR
  module R4
    class HealthcareService < FHIR::Model
      ...
      METADATA = {
        ...
        '_id' => {'type'=>'Element', 'path'=>'HealthcareService._id', 'min'=>0, 'max'=>1},
        ...
        '_implicitRules' => {'type'=>'Element', 'path'=>'HealthcareService._implicitRules', 'min'=>0, 'max'=>1},
        ...
        '_language' => {'type'=>'Element', 'path'=>'HealthcareService._language', 'min'=>0, 'max'=>1},
        ...
        '_active' => {'type'=>'Element', 'path'=>'HealthcareService._active', 'min'=>0, 'max'=>1},
        ...
        '_name' => {'type'=>'Element', 'path'=>'HealthcareService._name', 'min'=>0, 'max'=>1},
        'comment' => {'type'=>'string', 'path'=>'HealthcareService.comment', 'min'=>0, 'max'=>1},
        '_comment' => {'type'=>'Element', 'path'=>'HealthcareService._comment', 'min'=>0, 'max'=>1},
        'extraDetails' => {'type'=>'markdown', 'path'=>'HealthcareService.extraDetails', 'min'=>0, 'max'=>1},
        '_extraDetails' => {'type'=>'Element', 'path'=>'HealthcareService._extraDetails', 'min'=>0, 'max'=>1},
        ...
        '_appointmentRequired' => {'type'=>'Element', 'path'=>'HealthcareService._appointmentRequired', 'min'=>0, 'max'=>1},
        ...
        '_availabilityExceptions' => {'type'=>'Element', 'path'=>'HealthcareService._availabilityExceptions', 'min'=>0, 'max'=>1},
      ...
      class Eligibility < FHIR::Model
        ...
        METADATA = {
          ...
          '_id' => {'type'=>'Element', 'path'=>'Eligibility._id', 'min'=>0, 'max'=>1},
          ...
          '_comment' => {'type'=>'Element', 'path'=>'Eligibility._comment', 'min'=>0, 'max'=>1}
        }
      ...
      class AvailableTime < FHIR::Model
        ...
        METADATA = {
          ...
          '_id' => {'type'=>'Element', 'path'=>'AvailableTime._id', 'min'=>0, 'max'=>1},
          ...
          '_daysOfWeek' => {'type'=>'Element', 'path'=>'AvailableTime._daysOfWeek', 'min'=>0, 'max'=>Float::INFINITY},
          'allDay' => {'type'=>'boolean', 'path'=>'AvailableTime.allDay', 'min'=>0, 'max'=>1},
          '_allDay' => {'type'=>'Element', 'path'=>'AvailableTime._allDay', 'min'=>0, 'max'=>1},
          'availableStartTime' => {'type'=>'time', 'path'=>'AvailableTime.availableStartTime', 'min'=>0, 'max'=>1},
          '_availableStartTime' => {'type'=>'Element', 'path'=>'AvailableTime._availableStartTime', 'min'=>0, 'max'=>1},
          'availableEndTime' => {'type'=>'time', 'path'=>'AvailableTime.availableEndTime', 'min'=>0, 'max'=>1},
          '_availableEndTime' => {'type'=>'Element', 'path'=>'AvailableTime._availableEndTime', 'min'=>0, 'max'=>1}
        }
        ...
        attr_accessor :_daysOfWeek         # 0-* [ Element ]
        attr_accessor :allDay              # 0-1 boolean
        attr_accessor :_allDay             # 0-1 Element
        attr_accessor :availableStartTime  # 0-1 time
        attr_accessor :_availableStartTime # 0-1 Element
        attr_accessor :availableEndTime    # 0-1 time
        attr_accessor :_availableEndTime   # 0-1 Element
      end
      ...
      class NotAvailable < FHIR::Model
        ...
        METADATA = {
          ...
          '_id' => {'type'=>'Element', 'path'=>'NotAvailable._id', 'min'=>0, 'max'=>1},
          ...
          '_description' => {'type'=>'Element', 'path'=>'NotAvailable._description', 'min'=>0, 'max'=>1},
      ...
      attr_accessor :_extraDetails           # 0-1 Element
      ...
      attr_accessor :_appointmentRequired    # 0-1 Element
      ...
      attr_accessor :_availabilityExceptions # 0-1 Element
  ...
  HealthcareService = FHIR::R4::HealthcareService
end