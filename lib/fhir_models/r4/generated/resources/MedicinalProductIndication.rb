  ...
  module R4
    class MedicinalProductIndication < FHIR::Model
      ...
      METADATA = {
        ...
        '_id' => {'type'=>'Element', 'path'=>'MedicinalProductIndication._id', 'min'=>0, 'max'=>1},
        ...
        '_implicitRules' => {'type'=>'Element', 'path'=>'MedicinalProductIndication._implicitRules', 'min'=>0, 'max'=>1},
        ...
        '_language' => {'type'=>'Element', 'path'=>'MedicinalProductIndication._language', 'min'=>0, 'max'=>1},
