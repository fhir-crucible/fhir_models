module FHIR
  module R4
    class ClaimResponse < FHIR::Model
      ...
      METADATA = {
        ...
        '_id' => {'type'=>'Element', 'path'=>'ClaimResponse._id', 'min'=>0, 'max'=>1},
        'meta' => {'type'=>'Meta', 'path'=>'ClaimResponse.meta', 'min'=>0, 'max'=>1},
        'implicitRules' => {'type'=>'uri', 'path'=>'ClaimResponse.implicitRules', 'min'=>0, 'max'=>1},
        '_implicitRules' => {'type'=>'Element', 'path'=>'ClaimResponse._implicitRules', 'min'=>0, 'max'=>1},
        ...
        '_language' => {'type'=>'Element', 'path'=>'ClaimResponse._language', 'min'=>0, 'max'=>1},
        ...
        '_status' => {'type'=>'Element', 'path'=>'ClaimResponse._status', 'min'=>0, 'max'=>1},
        ...
        '_use' => {'type'=>'Element', 'path'=>'ClaimResponse._use', 'min'=>0, 'max'=>1},
        ...
        '_created' => {'type'=>'Element', 'path'=>'ClaimResponse._created', 'min'=>0, 'max'=>1},
        ...
        '_outcome' => {'type'=>'Element', 'path'=>'ClaimResponse._outcome', 'min'=>0, 'max'=>1},
        'disposition' => {'type'=>'string', 'path'=>'ClaimResponse.disposition', 'min'=>0, 'max'=>1},
        '_disposition' => {'type'=>'Element', 'path'=>'ClaimResponse._disposition', 'min'=>0, 'max'=>1},
        'preAuthRef' => {'type'=>'string', 'path'=>'ClaimResponse.preAuthRef', 'min'=>0, 'max'=>1},
        '_preAuthRef' => {'type'=>'Element', 'path'=>'ClaimResponse._preAuthRef', 'min'=>0, 'max'=>1},
      ...
      class Item < FHIR::Model
        ...
        METADATA = {
          ...
          '_itemSequence' => {'type'=>'Element', 'path'=>'Item._itemSequence', 'min'=>0, 'max'=>1},
        ...
        class Detail < FHIR::Model
          ...
          METADATA = {
            ...
            '_detailSequence' => {'type'=>'Element', 'path'=>'Detail._detailSequence', 'min'=>0, 'max'=>1},
          ...
          class SubDetail < FHIR::Model
            ...
            METADATA = {
              ...
              '_subDetailSequence' => {'type'=>'Element', 'path'=>'SubDetail._subDetailSequence', 'min'=>0, 'max'=>1},
            ...
            attr_accessor :_subDetailSequence # 0-1 Element
          ...
          attr_accessor :_detailSequence   # 0-1 Element
          attr_accessor :noteNumber        # 0-* [ positiveInt ]
          attr_accessor :_noteNumber       # 0-* [ Element ]
        ...
        attr_accessor :_itemSequence     # 0-1 Element
        attr_accessor :noteNumber        # 0-* [ positiveInt ]
        attr_accessor :_noteNumber       # 0-* [ Element ]
        attr_accessor :adjudication      # 1-* [ ClaimResponse::Item::Adjudication ]
      ...
      class Insurance < FHIR::Model
        ...
        METADATA = {
          ...
          '_sequence' => {'type'=>'Element', 'path'=>'Insurance._sequence', 'min'=>0, 'max'=>1},
          ...
          '_businessArrangement' => {'type'=>'Element', 'path'=>'Insurance._businessArrangement', 'min'=>0, 'max'=>1},
        ...
        attr_accessor :_businessArrangement # 0-1 Element
      ...
      class Error < FHIR::Model
        ...
        METADATA = {
          ...
          '_id' => {'type'=>'Element', 'path'=>'Error._id', 'min'=>0, 'max'=>1},
          ...
          '_itemSequence' => {'type'=>'Element', 'path'=>'Error._itemSequence', 'min'=>0, 'max'=>1},
          'detailSequence' => {'type'=>'positiveInt', 'path'=>'Error.detailSequence', 'min'=>0, 'max'=>1},
          '_detailSequence' => {'type'=>'Element', 'path'=>'Error._detailSequence', 'min'=>0, 'max'=>1},
          'subDetailSequence' => {'type'=>'positiveInt', 'path'=>'Error.subDetailSequence', 'min'=>0, 'max'=>1},
          '_subDetailSequence' => {'type'=>'Element', 'path'=>'Error._subDetailSequence', 'min'=>0, 'max'=>1},
      ...
      attr_accessor :_preAuthRef          # 0-1 Element
  ...
  ClaimResponse = FHIR::R4::ClaimResponse
end