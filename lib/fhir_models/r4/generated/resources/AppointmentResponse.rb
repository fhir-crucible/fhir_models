module FHIR
  module R4
    class AppointmentResponse < FHIR::Model
      ...
      METADATA = {
        ...
        '_id' => {'type'=>'Element', 'path'=>'AppointmentResponse._id', 'min'=>0, 'max'=>1},
        ...
        '_implicitRules' => {'type'=>'Element', 'path'=>'AppointmentResponse._implicitRules', 'min'=>0, 'max'=>1},
        ...
        '_language' => {'type'=>'Element', 'path'=>'AppointmentResponse._language', 'min'=>0, 'max'=>1},
        ...
        '_start' => {'type'=>'Element', 'path'=>'AppointmentResponse._start', 'min'=>0, 'max'=>1},
        'end' => {'type'=>'instant', 'path'=>'AppointmentResponse.end', 'min'=>0, 'max'=>1},
        '_end' => {'type'=>'Element', 'path'=>'AppointmentResponse._end', 'min'=>0, 'max'=>1},
        ...
        '_participantStatus' => {'type'=>'Element', 'path'=>'AppointmentResponse._participantStatus', 'min'=>0, 'max'=>1},
        'comment' => {'type'=>'string', 'path'=>'AppointmentResponse.comment', 'min'=>0, 'max'=>1},
        '_comment' => {'type'=>'Element', 'path'=>'AppointmentResponse._comment', 'min'=>0, 'max'=>1}
      }
      ...
      attr_accessor :_participantStatus # 0-1 Element
  ...
  AppointmentResponse = FHIR::R4::AppointmentResponse
end