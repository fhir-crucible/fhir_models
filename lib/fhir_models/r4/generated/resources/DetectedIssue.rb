module FHIR
  module R4
    class DetectedIssue < FHIR::Model
      ...
      METADATA = {
        ...
        '_id' => {'type'=>'Element', 'path'=>'DetectedIssue._id', 'min'=>0, 'max'=>1},
        'meta' => {'type'=>'Meta', 'path'=>'DetectedIssue.meta', 'min'=>0, 'max'=>1},
        'implicitRules' => {'type'=>'uri', 'path'=>'DetectedIssue.implicitRules', 'min'=>0, 'max'=>1},
        '_implicitRules' => {'type'=>'Element', 'path'=>'DetectedIssue._implicitRules', 'min'=>0, 'max'=>1},
        ...
        '_language' => {'type'=>'Element', 'path'=>'DetectedIssue._language', 'min'=>0, 'max'=>1},
        ...
        '_status' => {'type'=>'Element', 'path'=>'DetectedIssue._status', 'min'=>0, 'max'=>1},
        ...
        '_severity' => {'type'=>'Element', 'path'=>'DetectedIssue._severity', 'min'=>0, 'max'=>1},
        ...
        '_identifiedDateTime' => {'type'=>'Element', 'path'=>'DetectedIssue.identified[x]', 'min'=>0, 'max'=>1},
        ...
        '_detail' => {'type'=>'Element', 'path'=>'DetectedIssue._detail', 'min'=>0, 'max'=>1},
        'reference' => {'type'=>'uri', 'path'=>'DetectedIssue.reference', 'min'=>0, 'max'=>1},
        '_reference' => {'type'=>'Element', 'path'=>'DetectedIssue._reference', 'min'=>0, 'max'=>1},
      ...
      class Mitigation < FHIR::Model
        ...
        METADATA = {
          ...
          '_id' => {'type'=>'Element', 'path'=>'Mitigation._id', 'min'=>0, 'max'=>1},
          ...
          'action' => {'valid_codes'=>{'http://terminology.hl7.org/CodeSystem/v3-ActCode'=>['EMAUTH', '21', '1', '19', '2', '22', '23', '3', '4', '5', '6', '7', '14', '15', '16', '17', '18', '20', '8', '10', '11', '12', '13', '9']}, 'type'=>'CodeableConcept', 'path'=>'Mitigation.action', 'min'=>1, 'max'=>1, 'binding'=>{'strength'=>'preferred', 'uri'=>'http://hl7.org/fhir/ValueSet/detectedissue-mitigation-action'}},
          'date' => {'type'=>'dateTime', 'path'=>'Mitigation.date', 'min'=>0, 'max'=>1},
          '_date' => {'type'=>'Element', 'path'=>'Mitigation._date', 'min'=>0, 'max'=>1},
      ...
      attr_accessor :_identifiedDateTime # 0-1 Element
      ...
      attr_accessor :_detail             # 0-1 Element
  ...
  DetectedIssue = FHIR::R4::DetectedIssue
end