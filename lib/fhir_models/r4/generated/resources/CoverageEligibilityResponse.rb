  ...
  module R4
    class CoverageEligibilityResponse < FHIR::Model
      ...
      METADATA = {
        ...
        '_id' => {'type'=>'Element', 'path'=>'CoverageEligibilityResponse._id', 'min'=>0, 'max'=>1},
        ...
        '_implicitRules' => {'type'=>'Element', 'path'=>'CoverageEligibilityResponse._implicitRules', 'min'=>0, 'max'=>1},
        ...
        '_language' => {'type'=>'Element', 'path'=>'CoverageEligibilityResponse._language', 'min'=>0, 'max'=>1},
        ...
        '_status' => {'type'=>'Element', 'path'=>'CoverageEligibilityResponse._status', 'min'=>0, 'max'=>1},
        ...
        '_purpose' => {'type'=>'Element', 'path'=>'CoverageEligibilityResponse._purpose', 'min'=>0, 'max'=>Float::INFINITY},
        ...
        '_servicedDate' => {'type'=>'Element', 'path'=>'CoverageEligibilityResponse.serviced[x]', 'min'=>0, 'max'=>1},
        ...
        '_created' => {'type'=>'Element', 'path'=>'CoverageEligibilityResponse._created', 'min'=>0, 'max'=>1},
        ...
        '_outcome' => {'type'=>'Element', 'path'=>'CoverageEligibilityResponse._outcome', 'min'=>0, 'max'=>1},
        'disposition' => {'type'=>'string', 'path'=>'CoverageEligibilityResponse.disposition', 'min'=>0, 'max'=>1},
        '_disposition' => {'type'=>'Element', 'path'=>'CoverageEligibilityResponse._disposition', 'min'=>0, 'max'=>1},
        ...
        '_preAuthRef' => {'type'=>'Element', 'path'=>'CoverageEligibilityResponse._preAuthRef', 'min'=>0, 'max'=>1},
      ...
      class Insurance < FHIR::Model
        ...
        METADATA = {
          ...
          '_inforce' => {'type'=>'Element', 'path'=>'Insurance._inforce', 'min'=>0, 'max'=>1},
        ...
        class Item < FHIR::Model
          ...
          METADATA = {
            ...
            '_excluded' => {'type'=>'Element', 'path'=>'Item._excluded', 'min'=>0, 'max'=>1},
            'name' => {'type'=>'string', 'path'=>'Item.name', 'min'=>0, 'max'=>1},
            '_name' => {'type'=>'Element', 'path'=>'Item._name', 'min'=>0, 'max'=>1},
            'description' => {'type'=>'string', 'path'=>'Item.description', 'min'=>0, 'max'=>1},
            '_description' => {'type'=>'Element', 'path'=>'Item._description', 'min'=>0, 'max'=>1},
            ...
            '_authorizationRequired' => {'type'=>'Element', 'path'=>'Item._authorizationRequired', 'min'=>0, 'max'=>1},
            ...
            '_authorizationUrl' => {'type'=>'Element', 'path'=>'Item._authorizationUrl', 'min'=>0, 'max'=>1}
          }
          ...
          class Benefit < FHIR::Model
            ...
            METADATA = {
              ...
              '_id' => {'type'=>'Element', 'path'=>'Benefit._id', 'min'=>0, 'max'=>1},
              ...
              '_allowedUnsignedInt' => {'type'=>'Element', 'path'=>'Benefit.allowed[x]', 'min'=>0, 'max'=>1},
              'allowedString' => {'type'=>'string', 'path'=>'Benefit.allowed[x]', 'min'=>0, 'max'=>1},
              '_allowedString' => {'type'=>'Element', 'path'=>'Benefit.allowed[x]', 'min'=>0, 'max'=>1},
              ...
              '_usedUnsignedInt' => {'type'=>'Element', 'path'=>'Benefit.used[x]', 'min'=>0, 'max'=>1},
              'usedString' => {'type'=>'string', 'path'=>'Benefit.used[x]', 'min'=>0, 'max'=>1},
              '_usedString' => {'type'=>'Element', 'path'=>'Benefit.used[x]', 'min'=>0, 'max'=>1},
            ...
            attr_accessor :_usedString         # 0-1 Element
        ...
        attr_accessor :_inforce          # 0-1 Element
      ...
      attr_accessor :_purpose          # 0-* [ Element ]
