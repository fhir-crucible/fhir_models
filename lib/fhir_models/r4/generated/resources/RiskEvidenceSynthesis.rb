module FHIR
  module R4
    class RiskEvidenceSynthesis < FHIR::Model
      ...
      METADATA = {
        ...
        '_id' => {'type'=>'Element', 'path'=>'RiskEv_idenceSynthesis._id', 'min'=>0, 'max'=>1},
        ...
        '_implicitRules' => {'type'=>'Element', 'path'=>'RiskEvidenceSynthesis._implicitRules', 'min'=>0, 'max'=>1},
        ...
        '_language' => {'type'=>'Element', 'path'=>'RiskEvidenceSynthesis._language', 'min'=>0, 'max'=>1},
        ...
        '_url' => {'type'=>'Element', 'path'=>'RiskEvidenceSynthesis._url', 'min'=>0, 'max'=>1},
        ...
        '_version' => {'type'=>'Element', 'path'=>'RiskEvidenceSynthesis._version', 'min'=>0, 'max'=>1},
        'name' => {'type'=>'string', 'path'=>'RiskEvidenceSynthesis.name', 'min'=>0, 'max'=>1},
        '_name' => {'type'=>'Element', 'path'=>'RiskEvidenceSynthesis._name', 'min'=>0, 'max'=>1},
        'title' => {'type'=>'string', 'path'=>'RiskEvidenceSynthesis.title', 'min'=>0, 'max'=>1},
        '_title' => {'type'=>'Element', 'path'=>'RiskEvidenceSynthesis._title', 'min'=>0, 'max'=>1},
        'status' => {'valid_codes'=>{'http://hl7.org/fhir/publication-status'=>['draft', 'active', 'retired', 'unknown']}, 'type'=>'code', 'path'=>'RiskEvidenceSynthesis.status', 'min'=>1, 'max'=>1, 'binding'=>{'strength'=>'required', 'uri'=>'http://hl7.org/fhir/ValueSet/publication-status'}},
        '_status' => {'type'=>'Element', 'path'=>'RiskEvidenceSynthesis._status', 'min'=>0, 'max'=>1},
        'date' => {'type'=>'dateTime', 'path'=>'RiskEvidenceSynthesis.date', 'min'=>0, 'max'=>1},
        '_date' => {'type'=>'Element', 'path'=>'RiskEvidenceSynthesis._date', 'min'=>0, 'max'=>1},
        'publisher' => {'type'=>'string', 'path'=>'RiskEvidenceSynthesis.publisher', 'min'=>0, 'max'=>1},
        '_publisher' => {'type'=>'Element', 'path'=>'RiskEvidenceSynthesis._publisher', 'min'=>0, 'max'=>1},
        ...
        '_description' => {'type'=>'Element', 'path'=>'RiskEvidenceSynthesis._description', 'min'=>0, 'max'=>1},
        ...
        '_copyright' => {'type'=>'Element', 'path'=>'RiskEvidenceSynthesis._copyright', 'min'=>0, 'max'=>1},
        'approvalDate' => {'type'=>'date', 'path'=>'RiskEvidenceSynthesis.approvalDate', 'min'=>0, 'max'=>1},
        '_approvalDate' => {'type'=>'Element', 'path'=>'RiskEvidenceSynthesis._approvalDate', 'min'=>0, 'max'=>1},
        'lastReviewDate' => {'type'=>'date', 'path'=>'RiskEvidenceSynthesis.lastReviewDate', 'min'=>0, 'max'=>1},
        '_lastReviewDate' => {'type'=>'Element', 'path'=>'RiskEvidenceSynthesis._lastReviewDate', 'min'=>0, 'max'=>1},
      ...
      class SampleSize < FHIR::Model
        ...
        METADATA = {
          ...
          '_id' => {'type'=>'Element', 'path'=>'SampleSize._id', 'min'=>0, 'max'=>1},
          ...
          '_description' => {'type'=>'Element', 'path'=>'SampleSize._description', 'min'=>0, 'max'=>1},
          'numberOfStudies' => {'type'=>'integer', 'path'=>'SampleSize.numberOfStudies', 'min'=>0, 'max'=>1},
          '_numberOfStudies' => {'type'=>'Element', 'path'=>'SampleSize._numberOfStudies', 'min'=>0, 'max'=>1},
          'numberOfParticipants' => {'type'=>'integer', 'path'=>'SampleSize.numberOfParticipants', 'min'=>0, 'max'=>1},
          '_numberOfParticipants' => {'type'=>'Element', 'path'=>'SampleSize._numberOfParticipants', 'min'=>0, 'max'=>1}
        }
        ...
        attr_accessor :_numberOfStudies      # 0-1 Element
        attr_accessor :numberOfParticipants  # 0-1 integer
        attr_accessor :_numberOfParticipants # 0-1 Element
      end
      ...
      class RiskEstimate < FHIR::Model
        ...
        METADATA = {
          ...
          '_id' => {'type'=>'Element', 'path'=>'RiskEstimate._id', 'min'=>0, 'max'=>1},
        ...
        class PrecisionEstimate < FHIR::Model
          ...
          METADATA = {
            ...
            '_id' => {'type'=>'Element', 'path'=>'PrecisionEstimate._id', 'min'=>0, 'max'=>1},
            ...
            '_level' => {'type'=>'Element', 'path'=>'PrecisionEstimate._level', 'min'=>0, 'max'=>1},
            'from' => {'type'=>'decimal', 'path'=>'PrecisionEstimate.from', 'min'=>0, 'max'=>1},
            '_from' => {'type'=>'Element', 'path'=>'PrecisionEstimate._from', 'min'=>0, 'max'=>1},
            'to' => {'type'=>'decimal', 'path'=>'PrecisionEstimate.to', 'min'=>0, 'max'=>1},
            '_to' => {'type'=>'Element', 'path'=>'PrecisionEstimate._to', 'min'=>0, 'max'=>1}
          }
          ...
          attr_accessor :_level            # 0-1 Element
          attr_accessor :from              # 0-1 decimal
          attr_accessor :_from             # 0-1 Element
          attr_accessor :to                # 0-1 decimal
          attr_accessor :_to               # 0-1 Element
        end
        ...
        attr_accessor :_denominatorCount # 0-1 Element
        attr_accessor :numeratorCount    # 0-1 integer
        attr_accessor :_numeratorCount   # 0-1 Element
      ...
      class Certainty < FHIR::Model
        ...
        METADATA = {
          ...
          '_id' => {'type'=>'Element', 'path'=>'Certainty._id', 'min'=>0, 'max'=>1},
        ...
        class CertaintySubcomponent < FHIR::Model
          ...
          METADATA = {
            ...
            '_id' => {'type'=>'Element', 'path'=>'CertaintySubcomponent._id', 'min'=>0, 'max'=>1},
  ...
  RiskEvidenceSynthesis = FHIR::R4::RiskEvidenceSynthesis
end