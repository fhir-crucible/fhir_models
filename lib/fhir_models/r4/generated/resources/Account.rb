  ...
  module R4
    class Account < FHIR::Model
      ...
      METADATA = {
        ...
        '_id' => {'type'=>'Extension', 'path'=>'Account._id', 'min'=>0, 'max'=>Float::INFINITY},
        'meta' => {'type'=>'Meta', 'path'=>'Account.meta', 'min'=>0, 'max'=>1},
        'implicitRules' => {'type'=>'uri', 'path'=>'Account.implicitRules', 'min'=>0, 'max'=>1},
        '_implicitRules' => {'type'=>'Extension', 'path'=>'Account._implicitRules', 'min'=>0, 'max'=>Float::INFINITY},
        ...
        '_language' => {'type'=>'Extension', 'path'=>'Account._language', 'min'=>0, 'max'=>Float::INFINITY},
        ...
        '_status' => {'type'=>'Extension', 'path'=>'Account._status', 'min'=>0, 'max'=>Float::INFINITY},
        ...
        '_name' => {'type'=>'Extension', 'path'=>'Account._name', 'min'=>0, 'max'=>Float::INFINITY},
        ...
        '_description' => {'type'=>'Extension', 'path'=>'Account._description', 'min'=>0, 'max'=>Float::INFINITY},
      ...
      class Coverage < FHIR::Model
        ...
        METADATA = {
          ...
          '_id' => {'type'=>'Extension', 'path'=>'Coverage._id', 'min'=>0, 'max'=>Float::INFINITY},
          ...
          '_priority' => {'type'=>'Extension', 'path'=>'Coverage._priority', 'min'=>0, 'max'=>Float::INFINITY}
        }

        attr_accessor :id                # 0-1 string
        attr_accessor :_id               # 0-* [ Extension ]
        attr_accessor :extension         # 0-* [ Extension ]
        attr_accessor :modifierExtension # 0-* [ Extension ]
        attr_accessor :coverage          # 1-1 Reference(Coverage)
        attr_accessor :priority          # 0-1 positiveInt
        attr_accessor :_priority         # 0-* [ Extension ]
      end
      ...
      class Guarantor < FHIR::Model
        ...
        METADATA = {
          ...
          '_id' => {'type'=>'Extension', 'path'=>'Guarantor._id', 'min'=>0, 'max'=>Float::INFINITY},
          ...
          '_onHold' => {'type'=>'Extension', 'path'=>'Guarantor._onHold', 'min'=>0, 'max'=>Float::INFINITY},
        ...
        attr_accessor :_onHold           # 0-* [ Extension ]
      ...
      attr_accessor :_implicitRules    # 0-* [ Extension ]
      attr_accessor :language          # 0-1 code
      attr_accessor :_language         # 0-* [ Extension ]
      ...
      attr_accessor :_status           # 0-* [ Extension ]
      attr_accessor :type              # 0-1 CodeableConcept
      attr_accessor :name              # 0-1 string
      attr_accessor :_name             # 0-* [ Extension ]
      ...
      attr_accessor :_description      # 0-* [ Extension ]
