  ...
  module R4
    class Account < FHIR::Model
      ...
      METADATA = {
        ...
        '_id' => {'type'=>'Element', 'path'=>'Account._id', 'min'=>0, 'max'=>1},
        'meta' => {'type'=>'Meta', 'path'=>'Account.meta', 'min'=>0, 'max'=>1},
        'implicitRules' => {'type'=>'uri', 'path'=>'Account.implicitRules', 'min'=>0, 'max'=>1},
        '_implicitRules' => {'type'=>'Element', 'path'=>'Account._implicitRules', 'min'=>0, 'max'=>1},
        ...
        '_language' => {'type'=>'Element', 'path'=>'Account._language', 'min'=>0, 'max'=>1},
        ...
        '_status' => {'type'=>'Element', 'path'=>'Account._status', 'min'=>0, 'max'=>1},
        ...
        '_name' => {'type'=>'Element', 'path'=>'Account._name', 'min'=>0, 'max'=>1},
        ...
        '_description' => {'type'=>'Element', 'path'=>'Account._description', 'min'=>0, 'max'=>1},
      ...
      class Coverage < FHIR::Model
        ...
        METADATA = {
          ...
          '_priority' => {'type'=>'Element', 'path'=>'Coverage._priority', 'min'=>0, 'max'=>1}
        }
      ...
      class Guarantor < FHIR::Model
        ...
        METADATA = {
          ...
          '_id' => {'type'=>'Element', 'path'=>'Guarantor._id', 'min'=>0, 'max'=>1},
          ...
          '_onHold' => {'type'=>'Element', 'path'=>'Guarantor._onHold', 'min'=>0, 'max'=>1},
        ...
        attr_accessor :_onHold           # 0-1 Element
