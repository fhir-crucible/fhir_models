module FHIR
  module R4
    class ClinicalImpression < FHIR::Model
      ...
      METADATA = {
        ...
        '_id' => {'type'=>'Element', 'path'=>'ClinicalImpression._id', 'min'=>0, 'max'=>1},
        ...
        '_implicitRules' => {'type'=>'Element', 'path'=>'ClinicalImpression._implicitRules', 'min'=>0, 'max'=>1},
        'language' => {'valid_codes'=>{'urn:ietf:bcp:47'=>['ar', 'bn', 'cs', 'da', 'de', 'de-AT', 'de-CH', 'de-DE', 'el', 'en', 'en-AU', 'en-CA', 'en-GB', 'en-IN', 'en-NZ', 'en-SG', 'en-US', 'es', 'es-AR', 'es-ES', 'es-UY', 'fi', 'fr', 'fr-BE', 'fr-CH', 'fr-FR', 'fy', 'fy-NL', 'hi', 'hr', 'it', 'it-CH', 'it-IT', 'ja', 'ko', 'nl', 'nl-BE', 'nl-NL', 'no', 'no-NO', 'pa', 'pl', 'pt', 'pt-BR', 'ru', 'ru-RU', 'sr', 'sr-RS', 'sv', 'sv-SE', 'te', 'zh', 'zh-CN', 'zh-HK', 'zh-SG', 'zh-TW']}, 'type'=>'code', 'path'=>'ClinicalImpression.language', 'min'=>0, 'max'=>1, 'binding'=>{'strength'=>'preferred', 'uri'=>'http://hl7.org/fhir/ValueSet/languages'}},
        '_language' => {'type'=>'Element', 'path'=>'ClinicalImpression._language', 'min'=>0, 'max'=>1},
        ...
        'status' => {'valid_codes'=>{'http://hl7.org/fhir/event-status'=>['in-progress', 'completed', 'entered-in-error']}, 'type'=>'code', 'path'=>'ClinicalImpression.status', 'min'=>1, 'max'=>1, 'binding'=>{'strength'=>'required', 'uri'=>'http://hl7.org/fhir/ValueSet/clinicalimpression-status'}},
        '_status' => {'type'=>'Element', 'path'=>'ClinicalImpression._status', 'min'=>0, 'max'=>1},
        ...
        '_description' => {'type'=>'Element', 'path'=>'ClinicalImpression._description', 'min'=>0, 'max'=>1},
        ...
        '_effectiveDateTime' => {'type'=>'Element', 'path'=>'ClinicalImpression.effective[x]', 'min'=>0, 'max'=>1},
        ...
        '_date' => {'type'=>'Element', 'path'=>'ClinicalImpression._date', 'min'=>0, 'max'=>1},
        ...
        '_protocol' => {'type'=>'Element', 'path'=>'ClinicalImpression._protocol', 'min'=>0, 'max'=>Float::INFINITY},
        'summary' => {'type'=>'string', 'path'=>'ClinicalImpression.summary', 'min'=>0, 'max'=>1},
        '_summary' => {'type'=>'Element', 'path'=>'ClinicalImpression._summary', 'min'=>0, 'max'=>1},
      ...
      class Investigation < FHIR::Model
        ...
        METADATA = {
          ...
          '_id' => {'type'=>'Element', 'path'=>'Investigation._id', 'min'=>0, 'max'=>1},
          ...
          'code' => {'valid_codes'=>{'http://snomed.info/sct'=>['271336007', '160237006']}, 'type'=>'CodeableConcept', 'path'=>'Investigation.code', 'min'=>1, 'max'=>1, 'binding'=>{'strength'=>'example', 'uri'=>'http://hl7.org/fhir/ValueSet/investigation-sets'}},
      ...
      class Finding < FHIR::Model
        ...
        METADATA = {
          ...
          '_id' => {'type'=>'Element', 'path'=>'Finding._id', 'min'=>0, 'max'=>1},
          ...
          '_basis' => {'type'=>'Element', 'path'=>'Finding._basis', 'min'=>0, 'max'=>1}
        }
        ...
        attr_accessor :_basis              # 0-1 Element
      end
      ...
      attr_accessor :_effectiveDateTime       # 0-1 Element
      ...
      attr_accessor :_protocol                # 0-* [ Element ]
      attr_accessor :summary                  # 0-1 string
      attr_accessor :_summary                 # 0-1 Element
  ...
  ClinicalImpression = FHIR::R4::ClinicalImpression
end