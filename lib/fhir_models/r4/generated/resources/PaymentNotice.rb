module FHIR
  module R4
    class PaymentNotice < FHIR::Model
      ...
      METADATA = {
        ...
        '_id' => {'type'=>'Element', 'path'=>'PaymentNotice._id', 'min'=>0, 'max'=>1},
        'meta' => {'type'=>'Meta', 'path'=>'PaymentNotice.meta', 'min'=>0, 'max'=>1},
        'implicitRules' => {'type'=>'uri', 'path'=>'PaymentNotice.implicitRules', 'min'=>0, 'max'=>1},
        '_implicitRules' => {'type'=>'Element', 'path'=>'PaymentNotice._implicitRules', 'min'=>0, 'max'=>1},
        ...
        '_language' => {'type'=>'Element', 'path'=>'PaymentNotice._language', 'min'=>0, 'max'=>1},
        ...
        '_status' => {'type'=>'Element', 'path'=>'PaymentNotice._status', 'min'=>0, 'max'=>1},
        ...
        '_created' => {'type'=>'Element', 'path'=>'PaymentNotice._created', 'min'=>0, 'max'=>1},
        ...
        '_paymentDate' => {'type'=>'Element', 'path'=>'PaymentNotice._paymentDate', 'min'=>0, 'max'=>1},
  ...
  PaymentNotice = FHIR::R4::PaymentNotice
end