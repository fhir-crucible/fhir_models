module FHIR
  module R4
    class PaymentReconciliation < FHIR::Model
      ...
      METADATA = {
        ...
        '_id' => {'type'=>'Element', 'path'=>'PaymentReconciliation._id', 'min'=>0, 'max'=>1},
        ...
        '_implicitRules' => {'type'=>'Element', 'path'=>'PaymentReconciliation._implicitRules', 'min'=>0, 'max'=>1},
        ...
        '_language' => {'type'=>'Element', 'path'=>'PaymentReconciliation._language', 'min'=>0, 'max'=>1},
        ...
        '_status' => {'type'=>'Element', 'path'=>'PaymentReconciliation._status', 'min'=>0, 'max'=>1},
        ...
        '_created' => {'type'=>'Element', 'path'=>'PaymentReconciliation._created', 'min'=>0, 'max'=>1},
        ...
        '_outcome' => {'type'=>'Element', 'path'=>'PaymentReconciliation._outcome', 'min'=>0, 'max'=>1},
        'disposition' => {'type'=>'string', 'path'=>'PaymentReconciliation.disposition', 'min'=>0, 'max'=>1},
        '_disposition' => {'type'=>'Element', 'path'=>'PaymentReconciliation._disposition', 'min'=>0, 'max'=>1},
        'paymentDate' => {'type'=>'date', 'path'=>'PaymentReconciliation.paymentDate', 'min'=>1, 'max'=>1},
        '_paymentDate' => {'type'=>'Element', 'path'=>'PaymentReconciliation._paymentDate', 'min'=>0, 'max'=>1},
      ...
      class Detail < FHIR::Model
        ...
        METADATA = {
          ...
          '_date' => {'type'=>'Element', 'path'=>'Detail._date', 'min'=>0, 'max'=>1},
  ...
  PaymentReconciliation = FHIR::R4::PaymentReconciliation
end