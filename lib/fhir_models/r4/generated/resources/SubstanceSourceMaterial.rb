module FHIR
  module R4
    class SubstanceSourceMaterial < FHIR::Model
      ...
      METADATA = {
        ...
        '_id' => {'type'=>'Element', 'path'=>'SubstanceSourceMaterial._id', 'min'=>0, 'max'=>1},
        ...
        '_implicitRules' => {'type'=>'Element', 'path'=>'SubstanceSourceMaterial._implicitRules', 'min'=>0, 'max'=>1},
        ...
        '_language' => {'type'=>'Element', 'path'=>'SubstanceSourceMaterial._language', 'min'=>0, 'max'=>1},
        ...
        '_organismName' => {'type'=>'Element', 'path'=>'SubstanceSourceMaterial._organismName', 'min'=>0, 'max'=>1},
        ...
        '_parentSubstanceName' => {'type'=>'Element', 'path'=>'SubstanceSourceMaterial._parentSubstanceName', 'min'=>0, 'max'=>Float::INFINITY},
        ...
        '_geographicalLocation' => {'type'=>'Element', 'path'=>'SubstanceSourceMaterial._geographicalLocation', 'min'=>0, 'max'=>Float::INFINITY},
      ...
      class FractionDescription < FHIR::Model
        ...
        METADATA = {
          ...
          '_id' => {'type'=>'Element', 'path'=>'FractionDescription._id', 'min'=>0, 'max'=>1},
          ...
          '_fraction' => {'type'=>'Element', 'path'=>'FractionDescription._fraction', 'min'=>0, 'max'=>1},
        ...
        attr_accessor :_fraction         # 0-1 Element
      ...
      class Organism < FHIR::Model
        ...
        METADATA = {
          ...
          '_id' => {'type'=>'Element', 'path'=>'Organism._id', 'min'=>0, 'max'=>1},
          ...
          '_intraspecificDescription' => {'type'=>'Element', 'path'=>'Organism._intraspecificDescription', 'min'=>0, 'max'=>1},
        ...
        class Author < FHIR::Model
          ...
          METADATA = {
            ...
            '_id' => {'type'=>'Element', 'path'=>'Author._id', 'min'=>0, 'max'=>1},
            ...
            '_authorDescription' => {'type'=>'Element', 'path'=>'Author._authorDescription', 'min'=>0, 'max'=>1}
          }
          ...
          attr_accessor :_authorDescription # 0-1 Element
        end
        ...
        class Hybrid < FHIR::Model
          ...
          METADATA = {
            ...
            '_id' => {'type'=>'Element', 'path'=>'Hybr_id._id', 'min'=>0, 'max'=>1},
            ...
            '_maternalOrganismId' => {'type'=>'Element', 'path'=>'Hybrid._maternalOrganismId', 'min'=>0, 'max'=>1},
            'maternalOrganismName' => {'type'=>'string', 'path'=>'Hybrid.maternalOrganismName', 'min'=>0, 'max'=>1},
            '_maternalOrganismName' => {'type'=>'Element', 'path'=>'Hybrid._maternalOrganismName', 'min'=>0, 'max'=>1},
            'paternalOrganismId' => {'type'=>'string', 'path'=>'Hybrid.paternalOrganismId', 'min'=>0, 'max'=>1},
            '_paternalOrganismId' => {'type'=>'Element', 'path'=>'Hybrid._paternalOrganismId', 'min'=>0, 'max'=>1},
            'paternalOrganismName' => {'type'=>'string', 'path'=>'Hybrid.paternalOrganismName', 'min'=>0, 'max'=>1},
            '_paternalOrganismName' => {'type'=>'Element', 'path'=>'Hybrid._paternalOrganismName', 'min'=>0, 'max'=>1},
          ...
          attr_accessor :_maternalOrganismId   # 0-1 Element
          attr_accessor :maternalOrganismName  # 0-1 string
          attr_accessor :_maternalOrganismName # 0-1 Element
          attr_accessor :paternalOrganismId    # 0-1 string
          attr_accessor :_paternalOrganismId   # 0-1 Element
          attr_accessor :paternalOrganismName  # 0-1 string
          attr_accessor :_paternalOrganismName # 0-1 Element
        ...
        class OrganismGeneral < FHIR::Model
          ...
          METADATA = {
            ...
            '_id' => {'type'=>'Element', 'path'=>'OrganismGeneral._id', 'min'=>0, 'max'=>1},
        ...
        attr_accessor :_intraspecificDescription # 0-1 Element
      ...
      class PartDescription < FHIR::Model
        ...
        METADATA = {
          ...
          '_id' => {'type'=>'Element', 'path'=>'PartDescription._id', 'min'=>0, 'max'=>1},
  ...
  SubstanceSourceMaterial = FHIR::R4::SubstanceSourceMaterial
end