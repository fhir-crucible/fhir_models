module FHIR
  module R4
    class Composition < FHIR::Model
      ...
      METADATA = {
        ...
        '_id' => {'type'=>'Element', 'path'=>'Composition._id', 'min'=>0, 'max'=>1},
        'meta' => {'type'=>'Meta', 'path'=>'Composition.meta', 'min'=>0, 'max'=>1},
        'implicitRules' => {'type'=>'uri', 'path'=>'Composition.implicitRules', 'min'=>0, 'max'=>1},
        '_implicitRules' => {'type'=>'Element', 'path'=>'Composition._implicitRules', 'min'=>0, 'max'=>1},
        ...
        '_language' => {'type'=>'Element', 'path'=>'Composition._language', 'min'=>0, 'max'=>1},
        ...
        '_status' => {'type'=>'Element', 'path'=>'Composition._status', 'min'=>0, 'max'=>1},
        ...
        '_date' => {'type'=>'Element', 'path'=>'Composition._date', 'min'=>0, 'max'=>1},
        ...
        '_title' => {'type'=>'Element', 'path'=>'Composition._title', 'min'=>0, 'max'=>1},
        'confidentiality' => {'valid_codes'=>{'http://terminology.hl7.org/CodeSystem/v3-Confidentiality'=>['U', 'L', 'M', 'N', 'R', 'V']}, 'type'=>'code', 'path'=>'Composition.confidentiality', 'min'=>0, 'max'=>1, 'binding'=>{'strength'=>'required', 'uri'=>'http://terminology.hl7.org/ValueSet/v3-ConfidentialityClassification'}},
        '_confidentiality' => {'type'=>'Element', 'path'=>'Composition._confidentiality', 'min'=>0, 'max'=>1},
      ...
      class Attester < FHIR::Model
        ...
        METADATA = {
          ...
          '_id' => {'type'=>'Element', 'path'=>'Attester._id', 'min'=>0, 'max'=>1},
          ...
          '_mode' => {'type'=>'Element', 'path'=>'Attester._mode', 'min'=>0, 'max'=>1},
          'time' => {'type'=>'dateTime', 'path'=>'Attester.time', 'min'=>0, 'max'=>1},
          '_time' => {'type'=>'Element', 'path'=>'Attester._time', 'min'=>0, 'max'=>1},
      ...
      class RelatesTo < FHIR::Model
        ...
        METADATA = {
          ...
          'code' => {'valid_codes'=>{'http://hl7.org/fhir/document-relationship-type'=>['replaces', 'transforms', 'signs', 'appends']}, 'type'=>'code', 'path'=>'RelatesTo.code', 'min'=>1, 'max'=>1, 'binding'=>{'strength'=>'required', 'uri'=>'http://hl7.org/fhir/ValueSet/document-relationship-type'}},
          '_code' => {'type'=>'Element', 'path'=>'RelatesTo._code', 'min'=>0, 'max'=>1},
      ...
      class Event < FHIR::Model
        ...
        METADATA = {
          ...
          '_id' => {'type'=>'Element', 'path'=>'Event._id', 'min'=>0, 'max'=>1},
      ...
      class Section < FHIR::Model
        ...
        METADATA = {
          ...
          '_id' => {'type'=>'Element', 'path'=>'Section._id', 'min'=>0, 'max'=>1},
          ...
          '_title' => {'type'=>'Element', 'path'=>'Section._title', 'min'=>0, 'max'=>1},
          ...
          '_mode' => {'type'=>'Element', 'path'=>'Section._mode', 'min'=>0, 'max'=>1},
      ...
      attr_accessor :_confidentiality  # 0-1 Element
  ...
  Composition = FHIR::R4::Composition
end