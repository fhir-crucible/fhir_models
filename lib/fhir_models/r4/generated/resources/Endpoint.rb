  ...
  module R4
    class Endpoint < FHIR::Model
      ...
      METADATA = {
        ...
        '_implicitRules' => {'type'=>'Element', 'path'=>'Endpoint._implicitRules', 'min'=>0, 'max'=>1},
        ...
        '_language' => {'type'=>'Element', 'path'=>'Endpoint._language', 'min'=>0, 'max'=>1},
        ...
        '_status' => {'type'=>'Element', 'path'=>'Endpoint._status', 'min'=>0, 'max'=>1},
        ...
        '_name' => {'type'=>'Element', 'path'=>'Endpoint._name', 'min'=>0, 'max'=>1},
        ...
        '_payloadMimeType' => {'type'=>'Element', 'path'=>'Endpoint._payloadMimeType', 'min'=>0, 'max'=>Float::INFINITY},
        ...
        '_header' => {'type'=>'Element', 'path'=>'Endpoint._header', 'min'=>0, 'max'=>Float::INFINITY}
      }
      ...
      attr_accessor :_payloadMimeType     # 0-* [ Element ]
