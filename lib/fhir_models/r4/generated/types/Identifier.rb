  ...
  module R4
    class Identifier < FHIR::Model
      ...
      METADATA = {
        ...
        '_id' => {'type'=>'Element', 'path'=>'Identifier._id', 'min'=>0, 'max'=>1},
        ...
        '_use' => {'type'=>'Element', 'path'=>'Identifier._use', 'min'=>0, 'max'=>1},
        ...
        '_system' => {'type'=>'Element', 'path'=>'Identifier._system', 'min'=>0, 'max'=>1},
        'value' => {'type'=>'string', 'path'=>'Identifier.value', 'min'=>0, 'max'=>1},
        '_value' => {'type'=>'Element', 'path'=>'Identifier._value', 'min'=>0, 'max'=>1},
